    ...
    if (typeof J != "string" && !Array.isArray(J)) {
      for (const V in J)
        if (V !== "default" && !(V in K)) {
          ...
          ee && Object.defineProperty(K, V, ee.get ? ee : {
            enumerable: !0,
            get: () => J[V]
          });
        }
...
function ke() {
  if (typeof document > "u" || document.getElementById("qwenpaw-terminal-xterm-css")) return;
  const K = `
.xterm{padding:0}
...
`, ne = document.createElement("style");
  ne.id = "qwenpaw-terminal-xterm-css", ne.textContent = K, document.head.appendChild(ne);
}
ke();
async function xe() {
  const [{ Terminal: K }, { FitAddon: ne }, { WebLinksAddon: Q }] = await Promise.all([
    Promise.resolve().then(() => Re),
    Promise.resolve().then(() => Be),
    Promise.resolve().then(() => Me)
  ]);
  return { Terminal: K, FitAddon: ne, WebLinksAddon: Q };
}
function Le() {
  const { React: K, antd: ne, antdIcons: Q, getApiUrl: J, getApiToken: V } = window.QwenPaw.host, {
    Card: ee,
    Space: T,
    Button: s,
    Tag: o,
  ...
  } = Q || {}, { useState: f, useEffect: v, useRef: p, useCallback: c } = K, { Text: m, Title: y } = l, k = {
    default: {
      background: "#1a1b26",
      foreground: "#a9b1d6",
      cursor: "#c0caf5",
  ...
  function L() {
    var q, X;
    const w = p(null), R = p(null), B = p(null), P = p(null), W = p(null), [I, S] = f(!1), [b, E] = f("default"), [x, M] = f(14), [H, $] = f(null), j = c(() => J("terminal/ws").replace(/^http/, "ws"), []), D = c(() => V() || "", []);
    v(() => {
      if (!w.current || R.current) return;
      let N = !1;
      return (async () => {
        const { Terminal: G, FitAddon: z, WebLinksAddon: ae } = await xe();
        if (N) return;
        const Z = new G({
          theme: k[b],
          fontSize: x,
        ...
        Z.loadAddon(re), Z.loadAddon(oe), Z.open(w.current), re.fit(), R.current = Z, P.current = re, C(Z), Z.onData((se) => {
          var te;
          ((te = B.current) == null ? void 0 : te.readyState) === WebSocket.OPEN && B.current.send(
            JSON.stringify({ type: "input", data: se })
          );
        }), Z.onBinary((se) => {
          var te;
          if (((te = B.current) == null ? void 0 : te.readyState) === WebSocket.OPEN) {
            const ce = new Uint8Array(se.length);
            for (let le = 0; le < se.length; le++)
              ce[le] = se.charCodeAt(le) & 255;
            B.current.send(ce);
          }
        });
        const he = () => {
          var se;
          re.fit(), ((se = B.current) == null ? void 0 : se.readyState) === WebSocket.OPEN && B.current.send(
            JSON.stringify({
              type: "resize",
              cols: Z.cols,
              rows: Z.rows
        ...
        return ie.observe(w.current), () => {
          window.removeEventListener("resize", he), ie.disconnect();
        };
      })(), () => {
        N = !0, B.current && B.current.close(), R.current && (R.current.dispose(), R.current = null);
      };
    }, []);
    const C = c(
      (N) => {
        B.current && B.current.close();
        const G = j(), z = D(), ae = z ? `${G}?cols=${N.cols}&rows=${N.rows}&token=${z}` : `${G}?cols=${N.cols}&rows=${N.rows}`, Z = new WebSocket(ae);
        Z.binaryType = "arraybuffer", B.current = Z, Z.onopen = () => {
          S(!0), N.focus();
        }, Z.onmessage = (re) => {
          if (re.data instanceof ArrayBuffer) {
            const oe = new TextDecoder().decode(re.data);
            N.write(oe);
          } else if (typeof re.data == "string")
            try {
              const oe = JSON.parse(re.data);
              oe.type === "error" ? N.writeln(`\r
\x1B[31m[Error] ${oe.message}\x1B[0m`) : oe.type;
            } catch {
              N.write(re.data);
            }
        }, Z.onclose = () => {
...
\x1B[33m[Disconnected] Reconnecting in 3s...\x1B[0m`
    ...
    v(() => {
      R.current && (R.current.options.theme = k[b]);
    }, [b]), v(() => {
      var N;
      R.current && (R.current.options.fontSize = x, (N = P.current) == null || N.fit());
    }, [x]), v(() => {
      (async () => {
        try {
          const N = V(), G = {};
          N && (G.Authorization = `Bearer ${N}`);
          const z = await fetch(J("terminal/shell-info"), {
            headers: G
          });
          z.ok && $(await z.json());
        } catch {
    ...
    const O = c(() => {
      var N;
      (N = R.current) == null || N.clear();
    }, []), A = c(() => {
      var G;
      const N = (G = R.current) == null ? void 0 : G.getSelection();
      N ? navigator.clipboard.writeText(N).then(() => {
        _.success("Copied to clipboard");
      }) : _.info("No selection to copy");
    }, []), U = c(() => {
      W.current && clearTimeout(W.current), R.current && C(R.current);
    }, [C]), F = c(() => {
      var N;
      (N = P.current) == null || N.fit();
    }, []);
    return K.createElement(
      ...
      K.createElement(
        ...
        K.createElement(
          T,
          { size: "middle" },
          K.createElement(g, { style: { color: "#7aa2f7", fontSize: 18 } }),
          K.createElement(
            m,
            { strong: !0, style: { color: "#c0caf5", fontSize: 14 } },
            "Terminal"
          ),
          K.createElement(
            o,
        ...
        K.createElement(
          ...
          K.createElement(
            d,
            {
              ...
              onChange: E,
              style: { width: 140 },
              options: Object.keys(k).map((N) => ({
                value: N,
                label: N.replace(/_/g, " ").replace(/\b\w/g, (G) => G.toUpperCase())
              }))
            }
          ),
          K.createElement(
            d,
            {
              ...
              onChange: M,
              style: { width: 70 },
              options: [10, 12, 13, 14, 15, 16, 18, 20, 22, 24].map((N) => ({
                value: N,
                label: `${N}px`
              }))
            }
      ...
      K.createElement(
        ...
        K.createElement(
          m,
          { style: { color: "#565f89", fontSize: 12 } },
          `xterm.js v5 — ${((q = R.current) == null ? void 0 : q.cols) || 80}×${((X = R.current) == null ? void 0 : X.rows) || 24}`
        )
      )
    );
  }
  window.QwenPaw.registerRoutes(
...
(function(K, ne) {
  (function(Q, J) {
    ...
    var Q = { 4567: function(T, s, o) {
      var l = this && this.__decorate || function(e, t, a, f) {
        var v, p = arguments.length, c = p < 3 ? t : f === null ? f = Object.getOwnPropertyDescriptor(t, a) : f;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") c = Reflect.decorate(e, t, a, f);
        else for (var m = e.length - 1; m >= 0; m--) (v = e[m]) && (c = (p < 3 ? v(c) : p > 3 ? v(t, a, c) : v(t, a)) || c);
        return p > 3 && c && Object.defineProperty(t, a, c), c;
      ...
      const n = o(9042), d = o(9924), _ = o(844), g = o(4725), h = o(2585), i = o(3656);
      let r = s.AccessibilityManager = class extends _.Disposable {
        constructor(e, t, a, f) {
          ...
          for (let v = 0; v < this._terminal.rows; v++) this._rowElements[v] = this._createAccessibilityTreeNode(), this._rowContainer.appendChild(this._rowElements[v]);
...
` && (this._liveRegionLineCount++, this._liveRegionLineCount === 21 && (this._liveRegion.textContent += n.tooMuchOutput)));
        ...
        _renderRows(e, t) {
          ...
          for (let v = e; v <= t; v++) {
            const p = a.lines.get(a.ydisp + v), c = [], m = (p == null ? void 0 : p.translateToString(!0, void 0, void 0, c)) || "", y = (a.ydisp + v + 1).toString(), k = this._rowElements[v];
            k && (m.length === 0 ? (k.innerText = " ", this._rowColumns.set(k, [0, 1])) : (k.textContent = m, this._rowColumns.set(k, c)), k.setAttribute("aria-posinset", y), k.setAttribute("aria-setsize", f));
          }
        ...
        _handleBoundaryFocus(e, t) {
          ...
          let v, p;
          if (t === 0 ? (v = a, p = this._rowElements.pop(), this._rowContainer.removeChild(p)) : (v = this._rowElements.shift(), p = a, this._rowContainer.removeChild(v)), v.removeEventListener("focus", this._topBoundaryFocusListener), p.removeEventListener("focus", this._bottomBoundaryFocusListener), t === 0) {
        ...
        _handleSelectionChange() {
          ...
          const v = ({ node: y, offset: k }) => {
            ...
            const R = this._rowColumns.get(L);
            if (!R) return console.warn("columns is null. Race condition?"), null;
            let B = k < R.length ? R[k] : R.slice(-1)[0] + 1;
      ...
      s.AccessibilityManager = r = l([u(1, h.IInstantiationService), u(2, g.ICoreBrowserService), u(3, g.IRenderService)], r);
    }, 3614: (T, s) => {
      function o(d) {
        return d.replace(/\r?\n/g, "\r");
      }
      function l(d, _) {
        return _ ? "\x1B[200~" + d + "\x1B[201~" : d;
      }
      function u(d, _, g, h) {
        d = l(d = o(d), g.decPrivateModes.bracketedPasteMode && h.rawOptions.ignoreBracketedPasteMode !== !0), g.triggerDataEvent(d, !0), _.value = "";
      }
      function n(d, _, g) {
        const h = g.getBoundingClientRect(), i = d.clientX - h.left - 10, r = d.clientY - h.top - 10;
        _.style.width = "20px", _.style.height = "20px", _.style.left = `${i}px`, _.style.top = `${r}px`, _.style.zIndex = "1000", _.focus();
      }
      Object.defineProperty(s, "__esModule", { value: !0 }), s.rightClickHandler = s.moveTextAreaUnderMouseCursor = s.paste = s.handlePasteEvent = s.copyHandler = s.bracketTextForPaste = s.prepareTextForTerminal = void 0, s.prepareTextForTerminal = o, s.bracketTextForPaste = l, s.copyHandler = function(d, _) {
        d.clipboardData && d.clipboardData.setData("text/plain", _.selectionText), d.preventDefault();
      }, s.handlePasteEvent = function(d, _, g, h) {
        d.stopPropagation(), d.clipboardData && u(d.clipboardData.getData("text/plain"), _, g, h);
      }, s.paste = u, s.moveTextAreaUnderMouseCursor = n, s.rightClickHandler = function(d, _, g, h, i) {
        n(d, _, g), i && h.rightClickSelect(d), _.value = h.selectionText, _.select();
      };
    }, 7239: (T, s, o) => {
      ...
      s.ColorContrastCache = class {
        ...
        getCss(u, n) {
          return this._css.get(u, n);
        }
        setColor(u, n, d) {
          this._color.set(u, n, d);
        }
        getColor(u, n) {
          return this._color.get(u, n);
        }
        clear() {
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.addDisposableDomListener = void 0, s.addDisposableDomListener = function(o, l, u, n) {
        o.addEventListener(l, u, n);
        let d = !1;
        return { dispose: () => {
          d || (d = !0, o.removeEventListener(l, u, n));
        } };
      };
    }, 3551: function(T, s, o) {
      var l = this && this.__decorate || function(r, e, t, a) {
        var f, v = arguments.length, p = v < 3 ? e : a === null ? a = Object.getOwnPropertyDescriptor(e, t) : a;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") p = Reflect.decorate(r, e, t, a);
        else for (var c = r.length - 1; c >= 0; c--) (f = r[c]) && (p = (v < 3 ? f(p) : v > 3 ? f(e, t, p) : f(e, t)) || p);
        return v > 3 && p && Object.defineProperty(e, t, p), p;
      }, u = this && this.__param || function(r, e) {
        return function(t, a) {
          e(t, a, r);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.Linkifier = void 0;
      const n = o(3656), d = o(8460), _ = o(844), g = o(2585), h = o(4725);
      let i = s.Linkifier = class extends _.Disposable {
        get currentLink() {
          return this._currentLink;
        }
        constructor(r, e, t, a, f) {
          super(), this._element = r, this._mouseService = e, this._renderService = t, this._bufferService = a, this._linkProviderService = f, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this.register(new d.EventEmitter()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this.register(new d.EventEmitter()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this.register((0, _.getDisposeArrayDisposable)(this._linkCacheDisposables)), this.register((0, _.toDisposable)(() => {
            var v;
            this._lastMouseEvent = void 0, (v = this._activeProviderReplies) == null || v.clear();
        ...
        _handleHover(r) {
          if (this._activeLine !== r.y || this._wasResized) return this._clearCurrentLink(), this._askForLink(r, !1), void (this._wasResized = !1);
          this._currentLink && this._linkAtPosition(this._currentLink.link, r) || (this._clearCurrentLink(), this._askForLink(r, !0));
        }
        _askForLink(r, e) {
          var a, f;
          this._activeProviderReplies && e || ((a = this._activeProviderReplies) == null || a.forEach((v) => {
            v == null || v.forEach((p) => {
              p.link.dispose && p.link.dispose();
            });
          }), this._activeProviderReplies = /* @__PURE__ */ new Map(), this._activeLine = r.y);
          let t = !1;
          for (const [v, p] of this._linkProviderService.linkProviders.entries()) e ? (f = this._activeProviderReplies) != null && f.get(v) && (t = this._checkLinkProviderResult(v, r, t)) : p.provideLinks(r.y, (c) => {
            var y, k;
            if (this._isMouseOut) return;
            const m = c == null ? void 0 : c.map((L) => ({ link: L }));
            (y = this._activeProviderReplies) == null || y.set(v, m), t = this._checkLinkProviderResult(v, r, t), ((k = this._activeProviderReplies) == null ? void 0 : k.size) === this._linkProviderService.linkProviders.length && this._removeIntersectingLinks(r.y, this._activeProviderReplies);
          });
        }
        _removeIntersectingLinks(r, e) {
          ...
          for (let a = 0; a < e.size; a++) {
            const f = e.get(a);
            if (f) for (let v = 0; v < f.length; v++) {
              const p = f[v], c = p.link.range.start.y < r ? 0 : p.link.range.start.x, m = p.link.range.end.y > r ? this._bufferService.cols : p.link.range.end.x;
              for (let y = c; y <= m; y++) {
                if (t.has(y)) {
                  f.splice(v--, 1);
                  break;
        ...
        _checkLinkProviderResult(r, e, t) {
          ...
          const a = this._activeProviderReplies.get(r);
          let f = !1;
          for (let p = 0; p < r; p++) this._activeProviderReplies.has(p) && !this._activeProviderReplies.get(p) || (f = !0);
          if (!f && a) {
            const p = a.find((c) => this._linkAtPosition(c.link, e));
          ...
          if (this._activeProviderReplies.size === this._linkProviderService.linkProviders.length && !t) for (let p = 0; p < this._activeProviderReplies.size; p++) {
            const c = (v = this._activeProviderReplies.get(p)) == null ? void 0 : v.find((m) => this._linkAtPosition(m.link, e));
            if (c) {
        ...
        _clearCurrentLink(r, e) {
          this._currentLink && this._lastMouseEvent && (!r || !e || this._currentLink.link.range.start.y >= r && this._currentLink.link.range.end.y <= e) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, (0, _.disposeArray)(this._linkCacheDisposables));
        }
        _handleNewLink(r) {
          if (!this._lastMouseEvent) return;
          const e = this._positionFromMouseEvent(this._lastMouseEvent, this._element, this._mouseService);
          e && this._linkAtPosition(r.link, e) && (this._currentLink = r, this._currentLink.state = { decorations: { underline: r.link.decorations === void 0 || r.link.decorations.underline, pointerCursor: r.link.decorations === void 0 || r.link.decorations.pointerCursor }, isHovered: !0 }, this._linkHover(this._element, r.link, this._lastMouseEvent), r.link.decorations = {}, Object.defineProperties(r.link.decorations, { pointerCursor: { get: () => {
            var t, a;
            ...
            var a, f, v;
            (a = this._currentLink) != null && a.state && ((v = (f = this._currentLink) == null ? void 0 : f.state) == null ? void 0 : v.decorations.underline) !== t && (this._currentLink.state.decorations.underline = t, this._currentLink.state.isHovered && this._fireUnderlineEvent(r.link, t));
            ...
            if (this._currentLink.link.range.start.y >= a && this._currentLink.link.range.end.y <= f && (this._clearCurrentLink(a, f), this._lastMouseEvent)) {
              const v = this._positionFromMouseEvent(this._lastMouseEvent, this._element, this._mouseService);
              v && this._askForLink(v, !1);
            }
          })));
        }
        _linkHover(r, e, t) {
          var a;
          (a = this._currentLink) != null && a.state && (this._currentLink.state.isHovered = !0, this._currentLink.state.decorations.underline && this._fireUnderlineEvent(e, !0), this._currentLink.state.decorations.pointerCursor && r.classList.add("xterm-cursor-pointer")), e.hover && e.hover(t, e.text);
        }
        _fireUnderlineEvent(r, e) {
          const t = r.range, a = this._bufferService.buffer.ydisp, f = this._createLinkUnderlineEvent(t.start.x - 1, t.start.y - a - 1, t.end.x, t.end.y - a - 1, void 0);
          (e ? this._onShowLinkUnderline : this._onHideLinkUnderline).fire(f);
        }
        _linkLeave(r, e, t) {
          var a;
          (a = this._currentLink) != null && a.state && (this._currentLink.state.isHovered = !1, this._currentLink.state.decorations.underline && this._fireUnderlineEvent(e, !1), this._currentLink.state.decorations.pointerCursor && r.classList.remove("xterm-cursor-pointer")), e.leave && e.leave(t, e.text);
        }
        _linkAtPosition(r, e) {
          const t = r.range.start.y * this._bufferService.cols + r.range.start.x, a = r.range.end.y * this._bufferService.cols + r.range.end.x, f = e.y * this._bufferService.cols + e.x;
          return t <= f && f <= a;
        }
        _positionFromMouseEvent(r, e, t) {
          const a = t.getCoords(r, e, this._bufferService.cols, this._bufferService.rows);
          if (a) return { x: a[0], y: a[1] + this._bufferService.buffer.ydisp };
        }
        _createLinkUnderlineEvent(r, e, t, a, f) {
          return { x1: r, y1: e, x2: t, y2: a, cols: this._bufferService.cols, fg: f };
        }
      };
      s.Linkifier = i = l([u(1, h.IMouseService), u(2, h.IRenderService), u(3, g.IBufferService), u(4, h.ILinkProviderService)], i);
    }, 9042: (T, s) => {
      ...
      var l = this && this.__decorate || function(h, i, r, e) {
        var t, a = arguments.length, f = a < 3 ? i : e === null ? e = Object.getOwnPropertyDescriptor(i, r) : e;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") f = Reflect.decorate(h, i, r, e);
        else for (var v = h.length - 1; v >= 0; v--) (t = h[v]) && (f = (a < 3 ? t(f) : a > 3 ? t(i, r, f) : t(i, r)) || f);
        return a > 3 && f && Object.defineProperty(i, r, f), f;
      }, u = this && this.__param || function(h, i) {
        return function(r, e) {
          i(r, e, h);
        };
      };
      ...
      let _ = s.OscLinkProvider = class {
        constructor(h, i, r) {
          this._bufferService = h, this._optionsService = i, this._oscLinkService = r;
        }
        provideLinks(h, i) {
          var m;
          const r = this._bufferService.buffer.lines.get(h - 1);
          if (!r) return void i(void 0);
          const e = [], t = this._optionsService.rawOptions.linkHandler, a = new n.CellData(), f = r.getTrimmedLength();
          let v = -1, p = -1, c = !1;
          for (let y = 0; y < f; y++) if (p !== -1 || r.hasContent(y)) {
            if (r.loadCell(y, a), a.hasExtendedAttrs() && a.extended.urlId) {
              if (p === -1) {
                p = y, v = a.extended.urlId;
                continue;
              }
              c = a.extended.urlId !== v;
            } else p !== -1 && (c = !0);
            if (c || p !== -1 && y === f - 1) {
              const k = (m = this._oscLinkService.getLinkData(v)) == null ? void 0 : m.uri;
              if (k) {
                const L = { start: { x: p + 1, y: h }, end: { x: y + (c || y !== f - 1 ? 0 : 1), y: h } };
                let w = !1;
                if (!(t != null && t.allowNonHttpProtocols)) try {
                  const R = new URL(k);
                  ["http:", "https:"].includes(R.protocol) || (w = !0);
                } catch {
                  w = !0;
                }
                w || e.push({ text: k, range: L, activate: (R, B) => t ? t.activate(R, B, L) : g(0, B), hover: (R, B) => {
                  var P;
                  return (P = t == null ? void 0 : t.hover) == null ? void 0 : P.call(t, R, B, L);
                }, leave: (R, B) => {
                  var P;
                  return (P = t == null ? void 0 : t.leave) == null ? void 0 : P.call(t, R, B, L);
                } });
              }
              c = !1, a.hasExtendedAttrs() && a.extended.urlId ? (p = y, v = a.extended.urlId) : (p = -1, v = -1);
            }
          }
          i(e);
        }
...
WARNING: This link could potentially be dangerous`)) {
      ...
      s.OscLinkProvider = _ = l([u(0, d.IBufferService), u(1, d.IOptionsService), u(2, d.IOscLinkService)], _);
    }, 6193: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.RenderDebouncer = void 0, s.RenderDebouncer = class {
        constructor(o, l) {
          this._renderCallback = o, this._coreBrowserService = l, this._refreshCallbacks = [];
        }
        dispose() {
        ...
        refresh(o, l, u) {
          this._rowCount = u, o = o !== void 0 ? o : 0, l = l !== void 0 ? l : this._rowCount - 1, this._rowStart = this._rowStart !== void 0 ? Math.min(this._rowStart, o) : o, this._rowEnd = this._rowEnd !== void 0 ? Math.max(this._rowEnd, l) : l, this._animationFrame || (this._animationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._innerRefresh()));
        }
        _innerRefresh() {
      ...
      const l = o(3614), u = o(3656), n = o(3551), d = o(9042), _ = o(3730), g = o(1680), h = o(3107), i = o(5744), r = o(2950), e = o(1296), t = o(428), a = o(4269), f = o(5114), v = o(8934), p = o(3230), c = o(9312), m = o(4725), y = o(6731), k = o(8055), L = o(8969), w = o(8460), R = o(844), B = o(6114), P = o(8437), W = o(2584), I = o(7399), S = o(5941), b = o(9074), E = o(2585), x = o(5435), M = o(4567), H = o(779);
      class $ extends L.CoreTerminal {
        get onFocus() {
        ...
        _handleColorEvent(D) {
          if (this._themeService) for (const C of D) {
            ...
            switch (C.type) {
              case 0:
                const U = k.color.toColorRGB(O === "ansi" ? this._themeService.colors.ansi[C.index] : this._themeService.colors[O]);
                this.coreService.triggerDataEvent(`${W.C0.ESC}]${A};${(0, S.toRgbString)(U)}${W.C1_ESCAPED.ST}`);
                break;
              case 1:
                if (O === "ansi") this._themeService.modifyColors((F) => F.ansi[C.index] = k.channels.toColor(...C.color));
                else {
                  const F = O;
                  this._themeService.modifyColors((q) => q[F] = k.channels.toColor(...C.color));
                }
                break;
              case 2:
        ...
        _handleScreenReaderModeOptionChange(D) {
          D ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(M.AccessibilityManager, this)) : this._accessibilityManager.clear();
        }
        _handleTextAreaFocus(D) {
          this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(W.C0.ESC + "[I"), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire();
        }
        blur() {
          var D;
          return (D = this.textarea) == null ? void 0 : D.blur();
        }
        _handleTextAreaBlur() {
        ...
        _syncTextArea() {
          ...
          const D = this.buffer.ybase + this.buffer.y, C = this.buffer.lines.get(D);
          if (!C) return;
          const O = Math.min(this.buffer.x, this.cols - 1), A = this._renderService.dimensions.css.cell.height, U = C.getWidth(O), F = this._renderService.dimensions.css.cell.width * U, q = this.buffer.y * this._renderService.dimensions.css.cell.height, X = O * this._renderService.dimensions.css.cell.width;
          this.textarea.style.left = X + "px", this.textarea.style.top = q + "px", this.textarea.style.width = F + "px", this.textarea.style.height = A + "px", this.textarea.style.lineHeight = A + "px", this.textarea.style.zIndex = "-5";
        }
        _initGlobal() {
          this._bindKeys(), this.register((0, u.addDisposableDomListener)(this.element, "copy", (C) => {
            this.hasSelection() && (0, l.copyHandler)(C, this._selectionService);
          }));
          const D = (C) => (0, l.handlePasteEvent)(C, this.textarea, this.coreService, this.optionsService);
          this.register((0, u.addDisposableDomListener)(this.textarea, "paste", D)), this.register((0, u.addDisposableDomListener)(this.element, "paste", D)), B.isFirefox ? this.register((0, u.addDisposableDomListener)(this.element, "mousedown", (C) => {
          ...
          })) : this.register((0, u.addDisposableDomListener)(this.element, "contextmenu", (C) => {
            (0, l.rightClickHandler)(C, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
          })), B.isLinux && this.register((0, u.addDisposableDomListener)(this.element, "auxclick", (C) => {
        ...
        bindMouse() {
          const D = this, C = this.element;
          function O(F) {
            const q = D._mouseService.getMouseReportCoords(F, D.screenElement);
            if (!q) return !1;
            let X, N;
            switch (F.overrideType || F.type) {
              case "mousemove":
                N = 32, F.buttons === void 0 ? (X = 3, F.button !== void 0 && (X = F.button < 3 ? F.button : 3)) : X = 1 & F.buttons ? 0 : 4 & F.buttons ? 1 : 2 & F.buttons ? 2 : 3;
                break;
              case "mouseup":
                N = 0, X = F.button < 3 ? F.button : 3;
                break;
              case "mousedown":
                N = 1, X = F.button < 3 ? F.button : 3;
                break;
              case "wheel":
                if (D._customWheelEventHandler && D._customWheelEventHandler(F) === !1 || D.viewport.getLinesScrolled(F) === 0) return !1;
                N = F.deltaY < 0 ? 0 : 1, X = 4;
                break;
              default:
                return !1;
            }
            return !(N === void 0 || X === void 0 || X > 4) && D.coreMouseService.triggerMouseEvent({ col: q.col, row: q.row, x: q.x, y: q.y, button: X, action: N, ctrl: F.ctrlKey, alt: F.altKey, shift: F.shiftKey });
          }
          const A = { mouseup: null, wheel: null, mousedrag: null, mousemove: null }, U = { mouseup: (F) => (O(F), F.buttons || (this._document.removeEventListener("mouseup", A.mouseup), A.mousedrag && this._document.removeEventListener("mousemove", A.mousedrag)), this.cancel(F)), wheel: (F) => (O(F), this.cancel(F, !0)), mousedrag: (F) => {
            F.buttons && O(F);
          }, mousemove: (F) => {
            F.buttons || O(F);
          } };
          this.register(this.coreMouseService.onProtocolChange((F) => {
            F ? (this.optionsService.rawOptions.logLevel === "debug" && this._logService.debug("Binding to mouse events:", this.coreMouseService.explainEvents(F)), this.element.classList.add("enable-mouse-events"), this._selectionService.disable()) : (this._logService.debug("Unbinding from mouse events."), this.element.classList.remove("enable-mouse-events"), this._selectionService.enable()), 8 & F ? A.mousemove || (C.addEventListener("mousemove", U.mousemove), A.mousemove = U.mousemove) : (C.removeEventListener("mousemove", A.mousemove), A.mousemove = null), 16 & F ? A.wheel || (C.addEventListener("wheel", U.wheel, { passive: !1 }), A.wheel = U.wheel) : (C.removeEventListener("wheel", A.wheel), A.wheel = null), 2 & F ? A.mouseup || (A.mouseup = U.mouseup) : (this._document.removeEventListener("mouseup", A.mouseup), A.mouseup = null), 4 & F ? A.mousedrag || (A.mousedrag = U.mousedrag) : (this._document.removeEventListener("mousemove", A.mousedrag), A.mousedrag = null);
          })), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this.register((0, u.addDisposableDomListener)(C, "mousedown", (F) => {
            if (F.preventDefault(), this.focus(), this.coreMouseService.areMouseEventsActive && !this._selectionService.shouldForceSelection(F)) return O(F), A.mouseup && this._document.addEventListener("mouseup", A.mouseup), A.mousedrag && this._document.addEventListener("mousemove", A.mousedrag), this.cancel(F);
          })), this.register((0, u.addDisposableDomListener)(C, "wheel", (F) => {
            if (!A.wheel) {
              if (this._customWheelEventHandler && this._customWheelEventHandler(F) === !1) return !1;
              if (!this.buffer.hasScrollback) {
                const q = this.viewport.getLinesScrolled(F);
                if (q === 0) return;
                const X = W.C0.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (F.deltaY < 0 ? "A" : "B");
                let N = "";
                for (let G = 0; G < Math.abs(q); G++) N += X;
                return this.coreService.triggerDataEvent(N, !0), this.cancel(F, !0);
              }
              return this.viewport.handleWheel(F) ? this.cancel(F) : void 0;
            }
          }, { passive: !1 })), this.register((0, u.addDisposableDomListener)(C, "touchstart", (F) => {
            if (!this.coreMouseService.areMouseEventsActive) return this.viewport.handleTouchStart(F), this.cancel(F);
          }, { passive: !0 })), this.register((0, u.addDisposableDomListener)(C, "touchmove", (F) => {
            if (!this.coreMouseService.areMouseEventsActive) return this.viewport.handleTouchMove(F) ? void 0 : this.cancel(F);
          }, { passive: !1 }));
        }
        refresh(D, C) {
          var O;
          (O = this._renderService) == null || O.refreshRows(D, C);
        }
        updateCursorStyle(D) {
          var C;
          (C = this._selectionService) != null && C.shouldColumnSelect(D) ? this.element.classList.add("column-select") : this.element.classList.remove("column-select");
        }
        _showCursor() {
        ...
        scrollLines(D, C, O = 0) {
          var A;
          O === 1 ? (super.scrollLines(D, C, O), this.refresh(0, this.rows - 1)) : (A = this.viewport) == null || A.scrollLines(D);
        }
        paste(D) {
          (0, l.paste)(D, this.textarea, this.coreService, this.optionsService);
        }
        ...
        registerLinkProvider(D) {
          return this._linkProviderService.registerLinkProvider(D);
        }
        ...
        select(D, C, O) {
          this._selectionService.setSelection(D, C, O);
        }
        getSelection() {
        ...
        clearSelection() {
          var D;
          (D = this._selectionService) == null || D.clearSelection();
        }
        selectAll() {
          var D;
          (D = this._selectionService) == null || D.selectAll();
        }
        selectLines(D, C) {
          var O;
          (O = this._selectionService) == null || O.selectLines(D, C);
        }
        _keyDown(D) {
          if (this._keyDownHandled = !1, this._keyDownSeen = !0, this._customKeyEventHandler && this._customKeyEventHandler(D) === !1) return !1;
          const C = this.browser.isMac && this.options.macOptionIsMeta && D.altKey;
          if (!C && !this._compositionHelper.keydown(D)) return this.options.scrollOnUserInput && this.buffer.ybase !== this.buffer.ydisp && this.scrollToBottom(), !1;
          C || D.key !== "Dead" && D.key !== "AltGraph" || (this._unprocessedDeadKey = !0);
          const O = (0, I.evaluateKeyboardEvent)(D, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
          if (this.updateCursorStyle(D), O.type === 3 || O.type === 2) {
            const A = this.rows - 1;
            return this.scrollLines(O.type === 2 ? -A : A), this.cancel(D, !0);
          }
          return O.type === 1 && this.selectAll(), !!this._isThirdLevelShift(this.browser, D) || (O.cancel && this.cancel(D, !0), !O.key || !!(D.key && !D.ctrlKey && !D.altKey && !D.metaKey && D.key.length === 1 && D.key.charCodeAt(0) >= 65 && D.key.charCodeAt(0) <= 90) || (this._unprocessedDeadKey ? (this._unprocessedDeadKey = !1, !0) : (O.key !== W.C0.ETX && O.key !== W.C0.CR || (this.textarea.value = ""), this._onKey.fire({ key: O.key, domEvent: D }), this._showCursor(), this.coreService.triggerDataEvent(O.key, !0), !this.optionsService.rawOptions.screenReaderMode || D.altKey || D.ctrlKey ? this.cancel(D, !0) : void (this._keyDownHandled = !0))));
        }
        _isThirdLevelShift(D, C) {
          const O = D.isMac && !this.options.macOptionIsMeta && C.altKey && !C.ctrlKey && !C.metaKey || D.isWindows && C.altKey && C.ctrlKey && !C.metaKey || D.isWindows && C.getModifierState("AltGraph");
          return C.type === "keypress" ? O : O && (!C.keyCode || C.keyCode > 47);
        }
        _keyUp(D) {
          this._keyDownSeen = !1, this._customKeyEventHandler && this._customKeyEventHandler(D) === !1 || (function(C) {
        ...
        _keyPress(D) {
          ...
          else if (D.which === null || D.which === void 0) C = D.keyCode;
          else {
            if (D.which === 0 || D.charCode === 0) return !1;
            C = D.which;
          }
          return !(!C || (D.altKey || D.ctrlKey || D.metaKey) && !this._isThirdLevelShift(this.browser, D) || (C = String.fromCharCode(C), this._onKey.fire({ key: C, domEvent: D }), this._showCursor(), this.coreService.triggerDataEvent(C, !0), this._keyPressHandled = !0, this._unprocessedDeadKey = !1, 0));
        }
        _inputEvent(D) {
          if (D.data && D.inputType === "insertText" && (!D.composed || !this._keyDownSeen) && !this.optionsService.rawOptions.screenReaderMode) {
            ...
            const C = D.data;
            return this.coreService.triggerDataEvent(C, !0), this.cancel(D), !0;
          }
          return !1;
        }
        resize(D, C) {
          D !== this.cols || C !== this.rows ? super.resize(D, C) : this._charSizeService && !this._charSizeService.hasValidSize && this._charSizeService.measure();
        }
        _afterResize(D, C) {
          var O, A;
          (O = this._charSizeService) == null || O.measure(), (A = this.viewport) == null || A.syncScrollArea(!0);
        }
        clear() {
          var D;
          if (this.buffer.ybase !== 0 || this.buffer.y !== 0) {
            ...
            this._onScroll.fire({ position: this.buffer.ydisp, source: 0 }), (D = this.viewport) == null || D.reset(), this.refresh(0, this.rows - 1);
          }
        }
        reset() {
          var C, O;
          ...
          this._setup(), super.reset(), (C = this._selectionService) == null || C.reset(), this._decorationService.reset(), (O = this.viewport) == null || O.reset(), this._customKeyEventHandler = D, this.refresh(0, this.rows - 1);
        }
        clearTextureAtlas() {
          var D;
          (D = this._renderService) == null || D.clearTextureAtlas();
        }
        _reportFocus() {
          var D;
          (D = this.element) != null && D.classList.contains("focus") ? this.coreService.triggerDataEvent(W.C0.ESC + "[I") : this.coreService.triggerDataEvent(W.C0.ESC + "[O");
        }
        _reportWindowsOptions(D) {
          if (this._renderService) switch (D) {
            case x.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
              const C = this._renderService.dimensions.css.canvas.width.toFixed(0), O = this._renderService.dimensions.css.canvas.height.toFixed(0);
              this.coreService.triggerDataEvent(`${W.C0.ESC}[4;${O};${C}t`);
              break;
            case x.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
              const A = this._renderService.dimensions.css.cell.width.toFixed(0), U = this._renderService.dimensions.css.cell.height.toFixed(0);
              this.coreService.triggerDataEvent(`${W.C0.ESC}[6;${U};${A}t`);
          }
        }
        cancel(D, C) {
          if (this.options.cancelEvents || C) return D.preventDefault(), D.stopPropagation(), !1;
        }
      }
      s.Terminal = $;
    }, 9924: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.TimeBasedDebouncer = void 0, s.TimeBasedDebouncer = class {
        ...
        refresh(o, l, u) {
          this._rowCount = u, o = o !== void 0 ? o : 0, l = l !== void 0 ? l : this._rowCount - 1, this._rowStart = this._rowStart !== void 0 ? Math.min(this._rowStart, o) : o, this._rowEnd = this._rowEnd !== void 0 ? Math.max(this._rowEnd, l) : l;
          const n = Date.now();
          if (n - this._lastRefreshMs >= this._debounceThresholdMS) this._lastRefreshMs = n, this._innerRefresh();
          else if (!this._additionalRefreshRequested) {
            const d = n - this._lastRefreshMs, _ = this._debounceThresholdMS - d;
      ...
      const n = o(3656), d = o(4725), _ = o(8460), g = o(844), h = o(2585);
      let i = s.Viewport = class extends g.Disposable {
        constructor(r, e, t, a, f, v, p, c) {
        ...
        getBufferElements(r, e) {
          var c;
          let t, a = "";
          const f = [], v = e ?? this._bufferService.buffer.lines.length, p = this._bufferService.buffer.lines;
          for (let m = r; m < v; m++) {
            const y = p.get(m);
            if (!y) continue;
            const k = (c = p.get(m + 1)) == null ? void 0 : c.isWrapped;
            if (a += y.translateToString(!k), !k || m === p.length - 1) {
      ...
      s.Viewport = i = l([u(2, h.IBufferService), u(3, h.IOptionsService), u(4, d.ICharSizeService), u(5, d.IRenderService), u(6, d.ICoreBrowserService), u(7, d.IThemeService)], i);
    }, 3107: function(T, s, o) {
      var l = this && this.__decorate || function(h, i, r, e) {
        var t, a = arguments.length, f = a < 3 ? i : e === null ? e = Object.getOwnPropertyDescriptor(i, r) : e;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") f = Reflect.decorate(h, i, r, e);
      ...
      const n = o(4725), d = o(844), _ = o(2585);
      let g = s.BufferDecorationRenderer = class extends d.Disposable {
        constructor(h, i, r, e, t) {
          ...
          })), this.register(this._decorationService.onDecorationRegistered(() => this._queueRefresh())), this.register(this._decorationService.onDecorationRemoved((a) => this._removeDecoration(a))), this.register((0, d.toDisposable)(() => {
        ...
        _createElement(h) {
          ...
          const r = h.options.x ?? 0;
          return r && r > this._bufferService.cols && (i.style.display = "none"), this._refreshXPosition(h, i), i;
        }
        _refreshStyle(h) {
          ...
          if (i < 0 || i >= this._bufferService.rows) h.element && (h.element.style.display = "none", h.onRenderEmitter.fire(h.element));
            ...
            let r = this._decorationElements.get(h);
            r || (r = this._createElement(h), h.element = r, this._decorationElements.set(h, r), this._container.appendChild(r), h.onDispose(() => {
              this._decorationElements.delete(h), r.remove();
            })), r.style.top = i * this._renderService.dimensions.css.cell.height + "px", r.style.display = this._altBufferIsActive ? "none" : "block", h.onRenderEmitter.fire(r);
          }
        }
        _refreshXPosition(h, i = h.element) {
          if (!i) return;
          const r = h.options.x ?? 0;
          (h.options.anchor || "left") === "right" ? i.style.right = r ? r * this._renderService.dimensions.css.cell.width + "px" : "" : i.style.left = r ? r * this._renderService.dimensions.css.cell.width + "px" : "";
        }
        _removeDecoration(h) {
          var i;
      ...
      s.BufferDecorationRenderer = g = l([u(1, _.IBufferService), u(2, n.ICoreBrowserService), u(3, _.IDecorationService), u(4, n.IRenderService)], g);
    }, 5871: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.ColorZoneStore = void 0, s.ColorZoneStore = class {
        ...
        _lineAdjacentToZone(o, l, u) {
          return l >= o.startBufferLine - this._linePadding[u || "full"] && l <= o.endBufferLine + this._linePadding[u || "full"];
        }
        _addLineToZone(o, l) {
      ...
      var l = this && this.__decorate || function(t, a, f, v) {
        var p, c = arguments.length, m = c < 3 ? a : v === null ? v = Object.getOwnPropertyDescriptor(a, f) : v;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") m = Reflect.decorate(t, a, f, v);
        else for (var y = t.length - 1; y >= 0; y--) (p = t[y]) && (m = (c < 3 ? p(m) : c > 3 ? p(a, f, m) : p(a, f)) || m);
        return c > 3 && m && Object.defineProperty(a, f, m), m;
      }, u = this && this.__param || function(t, a) {
        return function(f, v) {
          a(f, v, t);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.OverviewRulerRenderer = void 0;
      const n = o(5871), d = o(4725), _ = o(844), g = o(2585), h = { full: 0, left: 0, center: 0, right: 0 }, i = { full: 0, left: 0, center: 0, right: 0 }, r = { full: 0, left: 0, center: 0, right: 0 };
      let e = s.OverviewRulerRenderer = class extends _.Disposable {
        get _width() {
          return this._optionsService.options.overviewRulerWidth || 0;
        }
        constructor(t, a, f, v, p, c, m) {
          var k;
          super(), this._viewportElement = t, this._screenElement = a, this._bufferService = f, this._decorationService = v, this._renderService = p, this._optionsService = c, this._coreBrowserService = m, this._colorZoneStore = new n.ColorZoneStore(), this._shouldUpdateDimensions = !0, this._shouldUpdateAnchor = !0, this._lastKnownBufferLength = 0, this._canvas = this._coreBrowserService.mainDocument.createElement("canvas"), this._canvas.classList.add("xterm-decoration-overview-ruler"), this._refreshCanvasDimensions(), (k = this._viewportElement.parentElement) == null || k.insertBefore(this._canvas, this._viewportElement);
        ...
        _refreshDrawConstants() {
          ...
          i.full = this._canvas.width, i.left = t, i.center = a, i.right = t, this._refreshDrawHeightConstants(), r.full = 0, r.left = 0, r.center = i.left, r.right = i.left + i.center;
        }
      ...
      s.OverviewRulerRenderer = e = l([u(2, g.IBufferService), u(3, g.IDecorationService), u(4, d.IRenderService), u(5, g.IOptionsService), u(6, d.ICoreBrowserService)], e);
    }, 2950: function(T, s, o) {
      var l = this && this.__decorate || function(h, i, r, e) {
        var t, a = arguments.length, f = a < 3 ? i : e === null ? e = Object.getOwnPropertyDescriptor(i, r) : e;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") f = Reflect.decorate(h, i, r, e);
      ...
      const n = o(4725), d = o(2585), _ = o(2584);
      let g = s.CompositionHelper = class {
        get isComposing() {
          return this._isComposing;
        }
        constructor(h, i, r, e, t, a) {
          this._textarea = h, this._compositionView = i, this._bufferService = r, this._optionsService = e, this._coreService = t, this._renderService = a, this._isComposing = !1, this._isSendingComposition = !1, this._compositionPosition = { start: 0, end: 0 }, this._dataAlreadySent = "";
        }
        compositionstart() {
          ...
          if (this._compositionView.classList.remove("active"), this._isComposing = !1, h) {
            ...
            this._isSendingComposition = !0, setTimeout(() => {
              if (this._isSendingComposition) {
                let r;
                this._isSendingComposition = !1, i.start += this._dataAlreadySent.length, r = this._isComposing ? this._textarea.value.substring(i.start, i.end) : this._textarea.value.substring(i.start), r.length > 0 && this._coreService.triggerDataEvent(r, !0);
              }
            }, 0);
          } else {
        ...
        _handleAnyTextareaChanges() {
          ...
          setTimeout(() => {
            if (!this._isComposing) {
              const i = this._textarea.value, r = i.replace(h, "");
              this._dataAlreadySent = r, i.length > h.length ? this._coreService.triggerDataEvent(r, !0) : i.length < h.length ? this._coreService.triggerDataEvent(`${_.C0.DEL}`, !0) : i.length === h.length && i !== h && this._coreService.triggerDataEvent(i, !0);
            }
          }, 0);
        }
        updateCompositionElements(h) {
          if (this._isComposing) {
            if (this._bufferService.buffer.isCursorInViewport) {
              const i = Math.min(this._bufferService.buffer.x, this._bufferService.cols - 1), r = this._renderService.dimensions.css.cell.height, e = this._bufferService.buffer.y * this._renderService.dimensions.css.cell.height, t = i * this._renderService.dimensions.css.cell.width;
      ...
      s.CompositionHelper = g = l([u(2, d.IBufferService), u(3, d.IOptionsService), u(4, d.ICoreService), u(5, n.IRenderService)], g);
    }, 9806: (T, s) => {
      function o(l, u, n) {
        const d = n.getBoundingClientRect(), _ = l.getComputedStyle(n), g = parseInt(_.getPropertyValue("padding-left")), h = parseInt(_.getPropertyValue("padding-top"));
        return [u.clientX - d.left - g, u.clientY - d.top - h];
      }
      Object.defineProperty(s, "__esModule", { value: !0 }), s.getCoords = s.getCoordsRelativeToElement = void 0, s.getCoordsRelativeToElement = o, s.getCoords = function(l, u, n, d, _, g, h, i, r) {
        if (!g) return;
        const e = o(l, u, n);
        return e ? (e[0] = Math.ceil((e[0] + (r ? h / 2 : 0)) / h), e[1] = Math.ceil(e[1] / i), e[0] = Math.min(Math.max(e[0], 1), d + (r ? 1 : 0)), e[1] = Math.min(Math.max(e[1], 1), _), e) : void 0;
      };
    }, 9504: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.moveToCellSequence = void 0;
      const l = o(2584);
      function u(i, r, e, t) {
        const a = i - n(i, e), f = r - n(r, e), v = Math.abs(a - f) - function(p, c, m) {
          let y = 0;
          const k = p - n(p, m), L = c - n(c, m);
          for (let w = 0; w < Math.abs(k - L); w++) {
            const R = d(p, c) === "A" ? -1 : 1, B = m.buffer.lines.get(k + R * w);
            B != null && B.isWrapped && y++;
          }
          return y;
        }(i, r, e);
        return h(v, g(d(i, r), t));
      }
      function n(i, r) {
        let e = 0, t = r.buffer.lines.get(i), a = t == null ? void 0 : t.isWrapped;
        for (; a && i >= 0 && i < r.rows; ) e++, t = r.buffer.lines.get(--i), a = t == null ? void 0 : t.isWrapped;
        return e;
      }
      function d(i, r) {
        return i > r ? "A" : "B";
      }
      function _(i, r, e, t, a, f) {
        let v = i, p = r, c = "";
        for (; v !== e || p !== t; ) v += a ? 1 : -1, a && v > f.cols - 1 ? (c += f.buffer.translateBufferLineToString(p, !1, i, v), v = 0, i = 0, p++) : !a && v < 0 && (c += f.buffer.translateBufferLineToString(p, !1, 0, i + 1), v = f.cols - 1, i = v, p--);
        return c + f.buffer.translateBufferLineToString(p, !1, i, v);
      }
      function g(i, r) {
        const e = r ? "O" : "[";
        return l.C0.ESC + e + i;
      ...
      function h(i, r) {
        i = Math.floor(i);
        let e = "";
        for (let t = 0; t < i; t++) e += r;
        return e;
      }
      s.moveToCellSequence = function(i, r, e, t) {
        const a = e.buffer.x, f = e.buffer.y;
        if (!e.buffer.hasScrollback) return function(c, m, y, k, L, w) {
          return u(m, k, L, w).length === 0 ? "" : h(_(c, m, c, m - n(m, L), !1, L).length, g("D", w));
        }(a, f, 0, r, e, t) + u(f, r, e, t) + function(c, m, y, k, L, w) {
          let R;
          R = u(m, k, L, w).length > 0 ? k - n(k, L) : m;
          const B = k, P = function(W, I, S, b, E, x) {
            let M;
            return M = u(S, b, E, x).length > 0 ? b - n(b, E) : I, W < S && M <= b || W >= S && M < b ? "C" : "D";
          }(c, m, y, k, L, w);
          return h(_(c, R, y, B, P === "C", L).length, g(P, w));
        }(a, f, i, r, e, t);
        let v;
        if (f === r) return v = a > i ? "D" : "C", h(Math.abs(a - i), g(v, t));
        v = f > r ? "D" : "C";
        const p = Math.abs(f - r);
        return h(function(c, m) {
          return m.cols - c;
        }(f > r ? i : a, e) + (p - 1) * e.cols + 1 + ((f > r ? a : i) - 1), g(v, t));
      };
    }, 1296: function(T, s, o) {
      var l = this && this.__decorate || function(w, R, B, P) {
        var W, I = arguments.length, S = I < 3 ? R : P === null ? P = Object.getOwnPropertyDescriptor(R, B) : P;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") S = Reflect.decorate(w, R, B, P);
        else for (var b = w.length - 1; b >= 0; b--) (W = w[b]) && (S = (I < 3 ? W(S) : I > 3 ? W(R, B, S) : W(R, B)) || S);
        return I > 3 && S && Object.defineProperty(R, B, S), S;
      }, u = this && this.__param || function(w, R) {
        return function(B, P) {
          R(B, P, w);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.DomRenderer = void 0;
      const n = o(3787), d = o(2550), _ = o(2223), g = o(6171), h = o(6052), i = o(4725), r = o(8055), e = o(8460), t = o(844), a = o(2585), f = "xterm-dom-renderer-owner-", v = "xterm-rows", p = "xterm-fg-", c = "xterm-bg-", m = "xterm-focus", y = "xterm-selection";
      let k = 1, L = s.DomRenderer = class extends t.Disposable {
        constructor(w, R, B, P, W, I, S, b, E, x, M, H, $) {
          super(), this._terminal = w, this._document = R, this._element = B, this._screenElement = P, this._viewportElement = W, this._helperContainer = I, this._linkifier2 = S, this._charSizeService = E, this._optionsService = x, this._bufferService = M, this._coreBrowserService = H, this._themeService = $, this._terminalClass = k++, this._rowElements = [], this._selectionRenderModel = (0, h.createSelectionRenderModel)(), this.onRequestRedraw = this.register(new e.EventEmitter()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(v), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add(y), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = (0, g.createRenderDimensions)(), this._updateDimensions(), this.register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this.register(this._themeService.onChangeColors((j) => this._injectCss(j))), this._injectCss(this._themeService.colors), this._rowFactory = b.createInstance(n.DomRendererRowFactory, document), this._element.classList.add(f + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this.register(this._linkifier2.onShowLinkUnderline((j) => this._handleLinkHover(j))), this.register(this._linkifier2.onHideLinkUnderline((j) => this._handleLinkLeave(j))), this.register((0, t.toDisposable)(() => {
        ...
        _updateDimensions() {
          ...
          const R = `${this._terminalSelector} .${v} span { display: inline-block; height: 100%; vertical-align: top;}`;
        ...
        _injectCss(w) {
          ...
          let R = `${this._terminalSelector} .${v} { color: ${w.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
          R += `${this._terminalSelector} .${v} .xterm-dim { color: ${r.color.multiplyOpacity(w.foreground, 0.5).css};}`, R += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
          const B = `blink_underline_${this._terminalClass}`, P = `blink_bar_${this._terminalClass}`, W = `blink_block_${this._terminalClass}`;
          R += `@keyframes ${B} { 50% {  border-bottom-style: hidden; }}`, R += `@keyframes ${P} { 50% {  box-shadow: none; }}`, R += `@keyframes ${W} { 0% {  background-color: ${w.cursor.css};  color: ${w.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${w.cursor.css}; }}`, R += `${this._terminalSelector} .${v}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${B} 1s step-end infinite;}${this._terminalSelector} .${v}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${P} 1s step-end infinite;}${this._terminalSelector} .${v}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${W} 1s step-end infinite;}${this._terminalSelector} .${v} .xterm-cursor.xterm-cursor-block { background-color: ${w.cursor.css}; color: ${w.cursorAccent.css};}${this._terminalSelector} .${v} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${w.cursor.css} !important; color: ${w.cursorAccent.css} !important;}${this._terminalSelector} .${v} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${w.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${v} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${w.cursor.css} inset;}${this._terminalSelector} .${v} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${w.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, R += `${this._terminalSelector} .${y} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${y} div { position: absolute; background-color: ${w.selectionBackgroundOpaque.css};}${this._terminalSelector} .${y} div { position: absolute; background-color: ${w.selectionInactiveBackgroundOpaque.css};}`;
          for (const [I, S] of w.ansi.entries()) R += `${this._terminalSelector} .${p}${I} { color: ${S.css}; }${this._terminalSelector} .${p}${I}.xterm-dim { color: ${r.color.multiplyOpacity(S, 0.5).css}; }${this._terminalSelector} .${c}${I} { background-color: ${S.css}; }`;
          R += `${this._terminalSelector} .${p}${_.INVERTED_DEFAULT_COLOR} { color: ${r.color.opaque(w.background).css}; }${this._terminalSelector} .${p}${_.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${r.color.multiplyOpacity(r.color.opaque(w.background), 0.5).css}; }${this._terminalSelector} .${c}${_.INVERTED_DEFAULT_COLOR} { background-color: ${w.foreground.css}; }`, this._themeStyleElement.textContent = R;
        }
        _setDefaultSpacing() {
          const w = this.dimensions.css.cell.width - this._widthCache.get("W", !1, !1);
          this._rowContainer.style.letterSpacing = `${w}px`, this._rowFactory.defaultSpacing = w;
        }
        handleDevicePixelRatioChange() {
          this._updateDimensions(), this._widthCache.clear(), this._setDefaultSpacing();
        }
        _refreshRowElements(w, R) {
          for (let B = this._rowElements.length; B <= R; B++) {
        ...
        handleResize(w, R) {
          this._refreshRowElements(w, R), this._updateDimensions(), this.handleSelectionChanged(this._selectionRenderModel.selectionStart, this._selectionRenderModel.selectionEnd, this._selectionRenderModel.columnSelectMode);
        }
        ...
        handleSelectionChanged(w, R, B) {
          if (this._selectionContainer.replaceChildren(), this._rowFactory.handleSelectionChanged(w, R, B), this.renderRows(0, this._bufferService.rows - 1), !w || !R) return;
          this._selectionRenderModel.update(this._terminal, w, R, B);
          const P = this._selectionRenderModel.viewportStartRow, W = this._selectionRenderModel.viewportEndRow, I = this._selectionRenderModel.viewportCappedStartRow, S = this._selectionRenderModel.viewportCappedEndRow;
          if (I >= this._bufferService.rows || S < 0) return;
          const b = this._document.createDocumentFragment();
          if (B) {
            const E = w[0] > R[0];
            b.appendChild(this._createSelectionElement(I, E ? R[0] : w[0], E ? w[0] : R[0], S - I + 1));
          } else {
            const E = P === I ? w[0] : 0, x = I === W ? R[0] : this._bufferService.cols;
            b.appendChild(this._createSelectionElement(I, E, x));
            const M = S - I - 1;
            if (b.appendChild(this._createSelectionElement(I + 1, 0, this._bufferService.cols, M)), I !== S) {
              const H = W === S ? R[0] : this._bufferService.cols;
              b.appendChild(this._createSelectionElement(S, 0, H));
            }
          }
          this._selectionContainer.appendChild(b);
        }
        _createSelectionElement(w, R, B, P = 1) {
          const W = this._document.createElement("div"), I = R * this.dimensions.css.cell.width;
          let S = this.dimensions.css.cell.width * (B - R);
          return I + S > this.dimensions.css.canvas.width && (S = this.dimensions.css.canvas.width - I), W.style.height = P * this.dimensions.css.cell.height + "px", W.style.top = w * this.dimensions.css.cell.height + "px", W.style.left = `${I}px`, W.style.width = `${S}px`, W;
        }
        handleCursorMove() {
        }
        ...
        renderRows(w, R) {
          const B = this._bufferService.buffer, P = B.ybase + B.y, W = Math.min(B.x, this._bufferService.cols - 1), I = this._optionsService.rawOptions.cursorBlink, S = this._optionsService.rawOptions.cursorStyle, b = this._optionsService.rawOptions.cursorInactiveStyle;
          for (let E = w; E <= R; E++) {
            const x = E + B.ydisp, M = this._rowElements[E], H = B.lines.get(x);
            if (!M || !H) break;
            M.replaceChildren(...this._rowFactory.createRow(H, x, x === P, S, b, W, I, this.dimensions.css.cell.width, this._widthCache, -1, -1));
          }
        }
        ...
        _handleLinkHover(w) {
          this._setCellUnderline(w.x1, w.x2, w.y1, w.y2, w.cols, !0);
        }
        _handleLinkLeave(w) {
          this._setCellUnderline(w.x1, w.x2, w.y1, w.y2, w.cols, !1);
        }
        _setCellUnderline(w, R, B, P, W, I) {
          B < 0 && (w = 0), P < 0 && (R = 0);
          const S = this._bufferService.rows - 1;
          B = Math.max(Math.min(B, S), 0), P = Math.max(Math.min(P, S), 0), W = Math.min(W, this._bufferService.cols);
          const b = this._bufferService.buffer, E = b.ybase + b.y, x = Math.min(b.x, W - 1), M = this._optionsService.rawOptions.cursorBlink, H = this._optionsService.rawOptions.cursorStyle, $ = this._optionsService.rawOptions.cursorInactiveStyle;
          for (let j = B; j <= P; ++j) {
            const D = j + b.ydisp, C = this._rowElements[j], O = b.lines.get(D);
            if (!C || !O) break;
            C.replaceChildren(...this._rowFactory.createRow(O, D, D === E, H, $, x, M, this.dimensions.css.cell.width, this._widthCache, I ? j === B ? w : 0 : -1, I ? (j === P ? R : W) - 1 : -1));
          }
        }
      };
      s.DomRenderer = L = l([u(7, a.IInstantiationService), u(8, i.ICharSizeService), u(9, a.IOptionsService), u(10, a.IBufferService), u(11, i.ICoreBrowserService), u(12, i.IThemeService)], L);
    }, 3787: function(T, s, o) {
      var l = this && this.__decorate || function(v, p, c, m) {
        var y, k = arguments.length, L = k < 3 ? p : m === null ? m = Object.getOwnPropertyDescriptor(p, c) : m;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") L = Reflect.decorate(v, p, c, m);
        else for (var w = v.length - 1; w >= 0; w--) (y = v[w]) && (L = (k < 3 ? y(L) : k > 3 ? y(p, c, L) : y(p, c)) || L);
        return k > 3 && L && Object.defineProperty(p, c, L), L;
      }, u = this && this.__param || function(v, p) {
        return function(c, m) {
          p(c, m, v);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.DomRendererRowFactory = void 0;
      const n = o(2223), d = o(643), _ = o(511), g = o(2585), h = o(8055), i = o(4725), r = o(4269), e = o(6171), t = o(3734);
      let a = s.DomRendererRowFactory = class {
        constructor(v, p, c, m, y, k, L) {
          this._document = v, this._characterJoinerService = p, this._optionsService = c, this._coreBrowserService = m, this._coreService = y, this._decorationService = k, this._themeService = L, this._workCell = new _.CellData(), this._columnSelectMode = !1, this.defaultSpacing = 0;
        }
        handleSelectionChanged(v, p, c) {
          this._selectionStart = v, this._selectionEnd = p, this._columnSelectMode = c;
        }
        createRow(v, p, c, m, y, k, L, w, R, B, P) {
          const W = [], I = this._characterJoinerService.getJoinedCharacters(p), S = this._themeService.colors;
          let b, E = v.getNoBgTrimmedLength();
          c && E < k + 1 && (E = k + 1);
          let x = 0, M = "", H = 0, $ = 0, j = 0, D = !1, C = 0, O = !1, A = 0;
          const U = [], F = B !== -1 && P !== -1;
          for (let q = 0; q < E; q++) {
            v.loadCell(q, this._workCell);
            let X = this._workCell.getWidth();
            if (X === 0) continue;
            let N = !1, G = q, z = this._workCell;
            if (I.length > 0 && q === I[0][0]) {
              N = !0;
              const Y = I.shift();
              z = new r.JoinedCellData(this._workCell, v.translateToString(!0, Y[0], Y[1]), Y[1] - Y[0]), G = Y[1] - 1, X = z.getWidth();
            }
            const ae = this._isCellInSelection(q, p), Z = c && q === k, re = F && q >= B && q <= P;
            let oe = !1;
            this._decorationService.forEachDecorationAtCell(q, p, void 0, (Y) => {
              oe = !0;
            });
            let he = z.getChars() || d.WHITESPACE_CELL_CHAR;
            if (he === " " && (z.isUnderline() || z.isOverline()) && (he = " "), A = X * w - R.get(he, z.isBold(), z.isItalic()), b) {
              if (x && (ae && O || !ae && !O && z.bg === H) && (ae && O && S.selectionForeground || z.fg === $) && z.extended.ext === j && re === D && A === C && !Z && !N && !oe) {
                z.isInvisible() ? M += d.WHITESPACE_CELL_CHAR : M += he, x++;
                continue;
              }
              x && (b.textContent = M), b = this._document.createElement("span"), x = 0, M = "";
            } else b = this._document.createElement("span");
            if (H = z.bg, $ = z.fg, j = z.extended.ext, D = re, C = A, O = ae, N && k >= q && k <= G && (k = q), !this._coreService.isCursorHidden && Z && this._coreService.isCursorInitialized) {
            ...
            if (z.isBold() && U.push("xterm-bold"), z.isItalic() && U.push("xterm-italic"), z.isDim() && U.push("xterm-dim"), M = z.isInvisible() ? d.WHITESPACE_CELL_CHAR : z.getChars() || d.WHITESPACE_CELL_CHAR, z.isUnderline() && (U.push(`xterm-underline-${z.extended.underlineStyle}`), M === " " && (M = " "), !z.isUnderlineColorDefault())) if (z.isUnderlineColorRGB()) b.style.textDecorationColor = `rgb(${t.AttributeData.toColorRGB(z.getUnderlineColor()).join(",")})`;
            else {
              let Y = z.getUnderlineColor();
              this._optionsService.rawOptions.drawBoldTextInBrightColors && z.isBold() && Y < 8 && (Y += 8), b.style.textDecorationColor = S.ansi[Y].css;
            }
            z.isOverline() && (U.push("xterm-overline"), M === " " && (M = " ")), z.isStrikethrough() && U.push("xterm-strikethrough"), re && (b.style.textDecoration = "underline");
            let ie = z.getFgColor(), se = z.getFgColorMode(), te = z.getBgColor(), ce = z.getBgColorMode();
            const le = !!z.isInverse();
            if (le) {
              const Y = ie;
              ie = te, te = Y;
              const Ee = se;
            ...
            let de, fe, ue, _e = !1;
            switch (this._decorationService.forEachDecorationAtCell(q, p, void 0, (Y) => {
              Y.options.layer !== "top" && _e || (Y.backgroundColorRGB && (ce = 50331648, te = Y.backgroundColorRGB.rgba >> 8 & 16777215, de = Y.backgroundColorRGB), Y.foregroundColorRGB && (se = 50331648, ie = Y.foregroundColorRGB.rgba >> 8 & 16777215, fe = Y.foregroundColorRGB), _e = Y.options.layer === "top");
            }), !_e && ae && (de = this._coreBrowserService.isFocused ? S.selectionBackgroundOpaque : S.selectionInactiveBackgroundOpaque, te = de.rgba >> 8 & 16777215, ce = 50331648, _e = !0, S.selectionForeground && (se = 50331648, ie = S.selectionForeground.rgba >> 8 & 16777215, fe = S.selectionForeground)), _e && U.push("xterm-decoration-top"), ce) {
              case 16777216:
              case 33554432:
                ue = S.ansi[te], U.push(`xterm-bg-${te}`);
                break;
              case 50331648:
                ue = h.channels.toColor(te >> 16, te >> 8 & 255, 255 & te), this._addStyle(b, `background-color:#${f((te >>> 0).toString(16), "0", 6)}`);
                break;
              default:
                le ? (ue = S.foreground, U.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`)) : ue = S.background;
            }
            switch (de || z.isDim() && (de = h.color.multiplyOpacity(ue, 0.5)), se) {
              case 16777216:
              case 33554432:
                z.isBold() && ie < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (ie += 8), this._applyMinimumContrast(b, ue, S.ansi[ie], z, de, void 0) || U.push(`xterm-fg-${ie}`);
                break;
              case 50331648:
                const Y = h.channels.toColor(ie >> 16 & 255, ie >> 8 & 255, 255 & ie);
                this._applyMinimumContrast(b, ue, Y, z, de, fe) || this._addStyle(b, `color:#${f(ie.toString(16), "0", 6)}`);
                break;
              default:
                this._applyMinimumContrast(b, ue, S.foreground, z, de, fe) || le && U.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`);
            }
            U.length && (b.className = U.join(" "), U.length = 0), Z || N || oe ? b.textContent = M : x++, A !== this.defaultSpacing && (b.style.letterSpacing = `${A}px`), W.push(b), q = G;
          }
          return b && x && (b.textContent = M), W;
        }
        _applyMinimumContrast(v, p, c, m, y, k) {
          ...
          if (y || k || (w = L.getColor(p.rgba, c.rgba)), w === void 0) {
            ...
            w = h.color.ensureContrastRatio(y || p, k || c, R), L.setColor((y || p).rgba, (k || c).rgba, w ?? null);
          }
        ...
        _addStyle(v, p) {
          v.setAttribute("style", `${v.getAttribute("style") || ""}${p};`);
        }
        _isCellInSelection(v, p) {
          const c = this._selectionStart, m = this._selectionEnd;
          return !(!c || !m) && (this._columnSelectMode ? c[0] <= m[0] ? v >= c[0] && p >= c[1] && v < m[0] && p <= m[1] : v < c[0] && p >= c[1] && v >= m[0] && p <= m[1] : p > c[1] && p < m[1] || c[1] === m[1] && p === c[1] && v >= c[0] && v < m[0] || c[1] < m[1] && p === m[1] && v < m[0] || c[1] < m[1] && p === c[1] && v >= c[0]);
        }
      };
      function f(v, p, c) {
        for (; v.length < c; ) v = p + v;
        return v;
      }
      s.DomRendererRowFactory = a = l([u(1, i.ICharacterJoinerService), u(2, g.IOptionsService), u(3, i.ICoreBrowserService), u(4, g.ICoreService), u(5, g.IDecorationService), u(6, i.IThemeService)], a);
    }, 2550: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.WidthCache = void 0, s.WidthCache = class {
        constructor(o, l) {
          ...
          _.classList.add("xterm-char-measure-element"), _.style.fontWeight = "bold", _.style.fontStyle = "italic", this._measureElements = [u, n, d, _], this._container.appendChild(u), this._container.appendChild(n), this._container.appendChild(d), this._container.appendChild(_), l.appendChild(this._container), this.clear();
        }
        dispose() {
        ...
        setFont(o, l, u, n) {
          o === this._font && l === this._fontSize && u === this._weight && n === this._weightBold || (this._font = o, this._fontSize = l, this._weight = u, this._weightBold = n, this._container.style.fontFamily = this._font, this._container.style.fontSize = `${this._fontSize}px`, this._measureElements[0].style.fontWeight = `${u}`, this._measureElements[1].style.fontWeight = `${n}`, this._measureElements[2].style.fontWeight = `${u}`, this._measureElements[3].style.fontWeight = `${n}`, this.clear());
        }
        get(o, l, u) {
          let n = 0;
          if (!l && !u && o.length === 1 && (n = o.charCodeAt(0)) < 256) {
            if (this._flat[n] !== -9999) return this._flat[n];
            const g = this._measure(o, 0);
            return g > 0 && (this._flat[n] = g), g;
          }
          let d = o;
          l && (d += "B"), u && (d += "I");
          let _ = this._holey.get(d);
          if (_ === void 0) {
            let g = 0;
            l && (g |= 1), u && (g |= 2), _ = this._measure(o, g), _ > 0 && this._holey.set(d, _);
          }
          return _;
        }
        _measure(o, l) {
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.computeNextVariantOffset = s.createRenderDimensions = s.treatGlyphAsBackgroundColor = s.allowRescaling = s.isEmoji = s.isRestrictedPowerlineGlyph = s.isPowerlineGlyph = s.throwIfFalsy = void 0, s.throwIfFalsy = function(u) {
        if (!u) throw new Error("value must not be falsy");
        return u;
      }, s.isPowerlineGlyph = o, s.isRestrictedPowerlineGlyph = function(u) {
        return 57520 <= u && u <= 57527;
      }, s.isEmoji = l, s.allowRescaling = function(u, n, d, _) {
        return n === 1 && d > Math.ceil(1.5 * _) && u !== void 0 && u > 255 && !l(u) && !o(u) && !function(g) {
          return 57344 <= g && g <= 63743;
        }(u);
      }, s.treatGlyphAsBackgroundColor = function(u) {
        return o(u) || function(n) {
          return 9472 <= n && n <= 9631;
        }(u);
      }, s.createRenderDimensions = function() {
        return { css: { canvas: { width: 0, height: 0 }, cell: { width: 0, height: 0 } }, device: { canvas: { width: 0, height: 0 }, cell: { width: 0, height: 0 }, char: { width: 0, height: 0, left: 0, top: 0 } } };
      }, s.computeNextVariantOffset = function(u, n, d = 0) {
        return (u - (2 * Math.round(n) - d)) % (2 * Math.round(n));
      };
    }, 6052: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.createSelectionRenderModel = void 0;
      class o {
        constructor() {
          this.clear();
        }
        ...
        update(u, n, d, _ = !1) {
          ...
          const g = u.buffers.active.ydisp, h = n[1] - g, i = d[1] - g, r = Math.max(h, 0), e = Math.min(i, u.rows - 1);
          r >= u.rows || e < 0 ? this.clear() : (this.hasSelection = !0, this.columnSelectMode = _, this.viewportStartRow = h, this.viewportEndRow = i, this.viewportCappedStartRow = r, this.viewportCappedEndRow = e, this.startCol = n[0], this.endCol = d[0]);
        }
        isCellSelected(u, n, d) {
      ...
      s.createSelectionRenderModel = function() {
        return new o();
      };
    }, 456: (T, s) => {
      ...
      const n = o(2585), d = o(8460), _ = o(844);
      let g = s.CharSizeService = class extends _.Disposable {
        get hasValidSize() {
          return this.width > 0 && this.height > 0;
        }
        constructor(e, t, a) {
          super(), this._optionsService = a, this.width = 0, this.height = 0, this._onCharSizeChange = this.register(new d.EventEmitter()), this.onCharSizeChange = this._onCharSizeChange.event;
          try {
      ...
      s.CharSizeService = g = l([u(2, n.IOptionsService)], g);
      ...
      const n = o(3734), d = o(643), _ = o(511), g = o(2585);
      ...
      s.JoinedCellData = h;
      let i = s.CharacterJoinerService = class me {
        constructor(e) {
        ...
        getJoinedCharacters(e) {
          ...
          let v = 0, p = 0, c = 0, m = t.getFg(0), y = t.getBg(0);
          for (let k = 0; k < t.getTrimmedLength(); k++) if (t.loadCell(k, this._workCell), this._workCell.getWidth() !== 0) {
            if (this._workCell.fg !== m || this._workCell.bg !== y) {
              if (k - v > 1) {
                const L = this._getJoinedRanges(f, c, p, t, v);
                for (let w = 0; w < L.length; w++) a.push(L[w]);
              }
              v = k, c = p, m = this._workCell.fg, y = this._workCell.bg;
            }
            p += this._workCell.getChars().length || d.WHITESPACE_CELL_CHAR.length;
          }
          if (this._bufferService.cols - v > 1) {
            const k = this._getJoinedRanges(f, c, p, t, v);
            for (let L = 0; L < k.length; L++) a.push(k[L]);
          }
          return a;
        }
        _getJoinedRanges(e, t, a, f, v) {
          const p = e.substring(t, a);
          let c = [];
          try {
        ...
        static _mergeRanges(e, t) {
          ...
          for (let f = 0; f < e.length; f++) {
            const v = e[f];
            if (a) {
              if (t[1] <= v[0]) return e[f - 1][1] = t[1], e;
              if (t[1] <= v[1]) return e[f - 1][1] = Math.max(t[1], v[1]), e.splice(f, 1), e;
              e.splice(f, 1), f--;
            } else {
              if (t[1] <= v[0]) return e.splice(f, 0, t), e;
              if (t[1] <= v[1]) return v[0] = Math.min(t[0], v[0]), e;
              t[0] < v[1] && (v[0] = Math.min(t[0], v[0]), a = !0);
            }
          }
          return a ? e[e.length - 1][1] = t[1] : e.push(t), e;
        }
      };
      s.CharacterJoinerService = i = l([u(0, g.IBufferService)], i);
    }, 5114: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.CoreBrowserService = void 0;
      const l = o(844), u = o(8460), n = o(3656);
      class d extends l.Disposable {
        constructor(h, i, r) {
          super(), this._textarea = h, this._window = i, this.mainDocument = r, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = new _(this._window), this._onDprChange = this.register(new u.EventEmitter()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this.register(new u.EventEmitter()), this.onWindowChange = this._onWindowChange.event, this.register(this.onWindowChange((e) => this._screenDprMonitor.setWindow(e))), this.register((0, u.forwardEvent)(this._screenDprMonitor.onDprChange, this._onDprChange)), this._textarea.addEventListener("focus", () => this._isFocused = !0), this._textarea.addEventListener("blur", () => this._isFocused = !1);
        }
        get window() {
          return this._window;
        }
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.LinkProviderService = void 0;
      const l = o(844);
      class u extends l.Disposable {
        ...
        registerLinkProvider(d) {
          return this.linkProviders.push(d), { dispose: () => {
            const _ = this.linkProviders.indexOf(d);
            _ !== -1 && this.linkProviders.splice(_, 1);
          } };
        }
      }
      s.LinkProviderService = u;
    }, 8934: function(T, s, o) {
      var l = this && this.__decorate || function(g, h, i, r) {
        var e, t = arguments.length, a = t < 3 ? h : r === null ? r = Object.getOwnPropertyDescriptor(h, i) : r;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") a = Reflect.decorate(g, h, i, r);
        else for (var f = g.length - 1; f >= 0; f--) (e = g[f]) && (a = (t < 3 ? e(a) : t > 3 ? e(h, i, a) : e(h, i)) || a);
        return t > 3 && a && Object.defineProperty(h, i, a), a;
      }, u = this && this.__param || function(g, h) {
        return function(i, r) {
          h(i, r, g);
        };
      };
      ...
      let _ = s.MouseService = class {
        constructor(g, h) {
          this._renderService = g, this._charSizeService = h;
        }
        getCoords(g, h, i, r, e) {
          return (0, d.getCoords)(window, g, h, i, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, e);
        }
        getMouseReportCoords(g, h) {
          const i = (0, d.getCoordsRelativeToElement)(window, g, h);
      ...
      s.MouseService = _ = l([u(0, n.IRenderService), u(1, n.ICharSizeService)], _);
    }, 3230: function(T, s, o) {
      var l = this && this.__decorate || function(e, t, a, f) {
        var v, p = arguments.length, c = p < 3 ? t : f === null ? f = Object.getOwnPropertyDescriptor(t, a) : f;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") c = Reflect.decorate(e, t, a, f);
      ...
      let r = s.RenderService = class extends g.Disposable {
        ...
        _registerIntersectionObserver(e, t) {
          if ("IntersectionObserver" in e) {
            ...
            a.observe(t), this._observerDisposable.value = (0, g.toDisposable)(() => a.disconnect());
          }
        }
      ...
      s.RenderService = r = l([u(2, i.IOptionsService), u(3, d.ICharSizeService), u(4, i.IDecorationService), u(5, i.IBufferService), u(6, d.ICoreBrowserService), u(7, d.IThemeService)], r);
    }, 9312: function(T, s, o) {
      var l = this && this.__decorate || function(c, m, y, k) {
        var L, w = arguments.length, R = w < 3 ? m : k === null ? k = Object.getOwnPropertyDescriptor(m, y) : k;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") R = Reflect.decorate(c, m, y, k);
        else for (var B = c.length - 1; B >= 0; B--) (L = c[B]) && (R = (w < 3 ? L(R) : w > 3 ? L(m, y, R) : L(m, y)) || R);
        return w > 3 && R && Object.defineProperty(m, y, R), R;
      }, u = this && this.__param || function(c, m) {
        return function(y, k) {
          m(y, k, c);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.SelectionService = void 0;
      const n = o(9806), d = o(9504), _ = o(456), g = o(4725), h = o(8460), i = o(844), r = o(6114), e = o(4841), t = o(511), a = o(2585), f = " ", v = new RegExp(f, "g");
      let p = s.SelectionService = class extends i.Disposable {
        constructor(c, m, y, k, L, w, R, B, P) {
          ...
          }), this._trimListener = this._bufferService.buffer.lines.onTrim((W) => this._handleTrim(W)), this.register(this._bufferService.buffers.onBufferActivate((W) => this._handleBufferActivate(W))), this.enable(), this._model = new _.SelectionModel(this._bufferService), this._activeSelectionMode = 0, this.register((0, i.toDisposable)(() => {
        ...
        get selectionText() {
          ...
          if (this._activeSelectionMode === 3) {
            ...
            for (let R = c[1]; R <= m[1]; R++) {
              const B = y.translateBufferLineToString(R, !0, L, w);
              k.push(B);
            }
          } else {
            const L = c[1] === m[1] ? m[0] : void 0;
            k.push(y.translateBufferLineToString(c[1], !0, c[0], L));
            for (let w = c[1] + 1; w <= m[1] - 1; w++) {
              const R = y.lines.get(w), B = y.translateBufferLineToString(w, !0);
              R != null && R.isWrapped ? k[k.length - 1] += B : k.push(B);
            }
            if (c[1] !== m[1]) {
              const w = y.lines.get(m[1]), R = y.translateBufferLineToString(m[1], !0, 0, m[0]);
              w && w.isWrapped ? k[k.length - 1] += R : k.push(R);
            }
          }
          return k.map((L) => L.replace(v, " ")).join(r.isWindows ? `\r
` : `
`);
        }
        clearSelection() {
        ...
        _getMouseBufferCoords(c) {
          const m = this._mouseService.getCoords(c, this._screenElement, this._bufferService.cols, this._bufferService.rows, !0);
        ...
        _handleSingleClick(c) {
          if (this._model.selectionStartLength = 0, this._model.isSelectAllActive = !1, this._activeSelectionMode = this.shouldColumnSelect(c) ? 3 : 0, this._model.selectionStart = this._getMouseBufferCoords(c), !this._model.selectionStart) return;
        ...
        _handleMouseMove(c) {
          ...
          if (this._model.selectionEnd = this._getMouseBufferCoords(c), !this._model.selectionEnd) return void this.refresh(!0);
        ...
        _handleMouseUp(c) {
          ...
          if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && m < 500 && c.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
            if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
              const y = this._mouseService.getCoords(c, this._element, this._bufferService.cols, this._bufferService.rows, !1);
        ...
        _getWordAt(c, m, y = !0, k = !0) {
          if (c[0] >= this._bufferService.cols) return;
          const L = this._bufferService.buffer, w = L.lines.get(c[1]);
          if (!w) return;
          const R = L.translateBufferLineToString(c[1], !1);
          let B = this._convertViewportColToCharacterIndex(w, c[0]), P = B;
          const W = c[0] - B;
          let I = 0, S = 0, b = 0, E = 0;
          if (R.charAt(B) === " ") {
            for (; B > 0 && R.charAt(B - 1) === " "; ) B--;
            for (; P < R.length && R.charAt(P + 1) === " "; ) P++;
          } else {
            let H = c[0], $ = c[0];
            w.getWidth(H) === 0 && (I++, H--), w.getWidth($) === 2 && (S++, $++);
            const j = w.getString($).length;
            for (j > 1 && (E += j - 1, P += j - 1); H > 0 && B > 0 && !this._isCharWordSeparator(w.loadCell(H - 1, this._workCell)); ) {
              w.loadCell(H - 1, this._workCell);
              const D = this._workCell.getChars().length;
              this._workCell.getWidth() === 0 ? (I++, H--) : D > 1 && (b += D - 1, B -= D - 1), B--, H--;
            }
            for (; $ < w.length && P + 1 < R.length && !this._isCharWordSeparator(w.loadCell($ + 1, this._workCell)); ) {
              w.loadCell($ + 1, this._workCell);
              const D = this._workCell.getChars().length;
              this._workCell.getWidth() === 2 ? (S++, $++) : D > 1 && (E += D - 1, P += D - 1), P++, $++;
            }
          }
          P++;
          let x = B + W - I + b, M = Math.min(this._bufferService.cols, P - B + I + S - b - E);
          if (m || R.slice(B, P).trim() !== "") {
            if (y && x === 0 && w.getCodePoint(0) !== 32) {
              const H = L.lines.get(c[1] - 1);
              if (H && w.isWrapped && H.getCodePoint(this._bufferService.cols - 1) !== 32) {
                const $ = this._getWordAt([this._bufferService.cols - 1, c[1] - 1], !1, !0, !1);
                if ($) {
                  const j = this._bufferService.cols - $.start;
                  x -= j, M += j;
                }
              }
            }
            if (k && x + M === this._bufferService.cols && w.getCodePoint(this._bufferService.cols - 1) !== 32) {
              const H = L.lines.get(c[1] + 1);
              if (H != null && H.isWrapped && H.getCodePoint(0) !== 32) {
                const $ = this._getWordAt([0, c[1] + 1], !1, !1, !0);
                $ && (M += $.length);
              }
            }
            return { start: x, length: M };
          }
        }
        _selectWordAt(c, m) {
      ...
      s.SelectionService = p = l([u(3, a.IBufferService), u(4, a.ICoreService), u(5, g.IMouseService), u(6, a.IOptionsService), u(7, g.IRenderService), u(8, g.ICoreBrowserService)], p);
    }, 4725: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.ILinkProviderService = s.IThemeService = s.ICharacterJoinerService = s.ISelectionService = s.IRenderService = s.IMouseService = s.ICoreBrowserService = s.ICharSizeService = void 0;
      const l = o(8343);
      s.ICharSizeService = (0, l.createDecorator)("CharSizeService"), s.ICoreBrowserService = (0, l.createDecorator)("CoreBrowserService"), s.IMouseService = (0, l.createDecorator)("MouseService"), s.IRenderService = (0, l.createDecorator)("RenderService"), s.ISelectionService = (0, l.createDecorator)("SelectionService"), s.ICharacterJoinerService = (0, l.createDecorator)("CharacterJoinerService"), s.IThemeService = (0, l.createDecorator)("ThemeService"), s.ILinkProviderService = (0, l.createDecorator)("LinkProviderService");
    }, 6731: function(T, s, o) {
      var l = this && this.__decorate || function(p, c, m, y) {
        ...
        else for (var R = p.length - 1; R >= 0; R--) (k = p[R]) && (w = (L < 3 ? k(w) : L > 3 ? k(c, m, w) : k(c, m)) || w);
        return L > 3 && w && Object.defineProperty(c, m, w), w;
      }, u = this && this.__param || function(p, c) {
        return function(m, y) {
          c(m, y, p);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.ThemeService = s.DEFAULT_ANSI_COLORS = void 0;
      const n = o(7239), d = o(8055), _ = o(8460), g = o(844), h = o(2585), i = d.css.toColor("#ffffff"), r = d.css.toColor("#000000"), e = d.css.toColor("#ffffff"), t = d.css.toColor("#000000"), a = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
      ...
      let f = s.ThemeService = class extends g.Disposable {
        get colors() {
          return this._colors;
        }
        constructor(p) {
          super(), this._optionsService = p, this._contrastCache = new n.ColorContrastCache(), this._halfContrastCache = new n.ColorContrastCache(), this._onChangeColors = this.register(new _.EventEmitter()), this.onChangeColors = this._onChangeColors.event, this._colors = { foreground: i, background: r, cursor: e, cursorAccent: t, selectionForeground: void 0, selectionBackgroundTransparent: a, selectionBackgroundOpaque: d.color.blend(r, a), selectionInactiveBackgroundTransparent: a, selectionInactiveBackgroundOpaque: d.color.blend(r, a), ansi: s.DEFAULT_ANSI_COLORS.slice(), contrastCache: this._contrastCache, halfContrastCache: this._halfContrastCache }, this._updateRestoreColors(), this._setTheme(this._optionsService.rawOptions.theme), this.register(this._optionsService.onSpecificOptionChange("minimumContrastRatio", () => this._contrastCache.clear())), this.register(this._optionsService.onSpecificOptionChange("theme", () => this._setTheme(this._optionsService.rawOptions.theme)));
        }
        _setTheme(p = {}) {
          const c = this._colors;
          if (c.foreground = v(p.foreground, i), c.background = v(p.background, r), c.cursor = v(p.cursor, e), c.cursorAccent = v(p.cursorAccent, t), c.selectionBackgroundTransparent = v(p.selectionBackground, a), c.selectionBackgroundOpaque = d.color.blend(c.background, c.selectionBackgroundTransparent), c.selectionInactiveBackgroundTransparent = v(p.selectionInactiveBackground, c.selectionBackgroundTransparent), c.selectionInactiveBackgroundOpaque = d.color.blend(c.background, c.selectionInactiveBackgroundTransparent), c.selectionForeground = p.selectionForeground ? v(p.selectionForeground, d.NULL_COLOR) : void 0, c.selectionForeground === d.NULL_COLOR && (c.selectionForeground = void 0), d.color.isOpaque(c.selectionBackgroundTransparent) && (c.selectionBackgroundTransparent = d.color.opacity(c.selectionBackgroundTransparent, 0.3)), d.color.isOpaque(c.selectionInactiveBackgroundTransparent) && (c.selectionInactiveBackgroundTransparent = d.color.opacity(c.selectionInactiveBackgroundTransparent, 0.3)), c.ansi = s.DEFAULT_ANSI_COLORS.slice(), c.ansi[0] = v(p.black, s.DEFAULT_ANSI_COLORS[0]), c.ansi[1] = v(p.red, s.DEFAULT_ANSI_COLORS[1]), c.ansi[2] = v(p.green, s.DEFAULT_ANSI_COLORS[2]), c.ansi[3] = v(p.yellow, s.DEFAULT_ANSI_COLORS[3]), c.ansi[4] = v(p.blue, s.DEFAULT_ANSI_COLORS[4]), c.ansi[5] = v(p.magenta, s.DEFAULT_ANSI_COLORS[5]), c.ansi[6] = v(p.cyan, s.DEFAULT_ANSI_COLORS[6]), c.ansi[7] = v(p.white, s.DEFAULT_ANSI_COLORS[7]), c.ansi[8] = v(p.brightBlack, s.DEFAULT_ANSI_COLORS[8]), c.ansi[9] = v(p.brightRed, s.DEFAULT_ANSI_COLORS[9]), c.ansi[10] = v(p.brightGreen, s.DEFAULT_ANSI_COLORS[10]), c.ansi[11] = v(p.brightYellow, s.DEFAULT_ANSI_COLORS[11]), c.ansi[12] = v(p.brightBlue, s.DEFAULT_ANSI_COLORS[12]), c.ansi[13] = v(p.brightMagenta, s.DEFAULT_ANSI_COLORS[13]), c.ansi[14] = v(p.brightCyan, s.DEFAULT_ANSI_COLORS[14]), c.ansi[15] = v(p.brightWhite, s.DEFAULT_ANSI_COLORS[15]), p.extendedAnsi) {
            const m = Math.min(c.ansi.length - 16, p.extendedAnsi.length);
            for (let y = 0; y < m; y++) c.ansi[y + 16] = v(p.extendedAnsi[y], s.DEFAULT_ANSI_COLORS[y + 16]);
          }
      ...
      class n extends u.Disposable {
        ...
        set maxLength(_) {
          ...
          const g = new Array(_);
          for (let h = 0; h < Math.min(_, this.length); h++) g[h] = this._array[this._getCyclicIndex(h)];
          this._array = g, this._maxLength = _, this._startIndex = 0;
        }
        get length() {
          return this._length;
        }
        set length(_) {
          if (_ > this._length) for (let g = this._length; g < _; g++) this._array[g] = void 0;
          this._length = _;
        }
        get(_) {
        ...
        set(_, g) {
          this._array[this._getCyclicIndex(_)] = g;
        }
        push(_) {
        ...
        splice(_, g, ...h) {
          if (g) {
            for (let i = _; i < this._length - g; i++) this._array[this._getCyclicIndex(i)] = this._array[this._getCyclicIndex(i + g)];
            this._length -= g, this.onDeleteEmitter.fire({ index: _, amount: g });
          }
        ...
        shiftElements(_, g, h) {
          if (!(g <= 0)) {
            ...
            if (h > 0) {
              for (let r = g - 1; r >= 0; r--) this.set(_ + r + h, this.get(_ + r));
              const i = _ + g + h - this._length;
              if (i > 0) for (this._length += i; this._length > this._maxLength; ) this._length--, this._startIndex++, this.onTrimEmitter.fire(1);
            } else for (let i = 0; i < g; i++) this.set(_ + i + h, this.get(_ + i));
          }
        }
        _getCyclicIndex(_) {
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.clone = void 0, s.clone = function o(l, u = 5) {
        if (typeof l != "object") return l;
        const n = Array.isArray(l) ? [] : {};
        for (const d in l) n[d] = u <= 1 ? l[d] : l[d] && o(l[d], u - 1);
        return n;
      };
    }, 8055: (T, s) => {
      ...
      s.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(t) {
        t.toCss = function(a, f, v, p) {
          return p !== void 0 ? `#${r(a)}${r(f)}${r(v)}${r(p)}` : `#${r(a)}${r(f)}${r(v)}`;
        }, t.toRgba = function(a, f, v, p = 255) {
          return (a << 24 | f << 16 | v << 8 | p) >>> 0;
        }, t.toColor = function(a, f, v, p) {
          return { css: t.toCss(a, f, v, p), rgba: t.toRgba(a, f, v, p) };
        };
      }(d || (s.channels = d = {})), function(t) {
        function a(f, v) {
          return n = Math.round(255 * v), [o, l, u] = i.toChannels(f.rgba), { css: d.toCss(o, l, u, n), rgba: d.toRgba(o, l, u, n) };
        }
        t.blend = function(f, v) {
          if (n = (255 & v.rgba) / 255, n === 1) return { css: v.css, rgba: v.rgba };
          const p = v.rgba >> 24 & 255, c = v.rgba >> 16 & 255, m = v.rgba >> 8 & 255, y = f.rgba >> 24 & 255, k = f.rgba >> 16 & 255, L = f.rgba >> 8 & 255;
          return o = y + Math.round((p - y) * n), l = k + Math.round((c - k) * n), u = L + Math.round((m - L) * n), { css: d.toCss(o, l, u), rgba: d.toRgba(o, l, u) };
        }, t.isOpaque = function(f) {
          return (255 & f.rgba) == 255;
        }, t.ensureContrastRatio = function(f, v, p) {
          const c = i.ensureContrastRatio(f.rgba, v.rgba, p);
          if (c) return d.toColor(c >> 24 & 255, c >> 16 & 255, c >> 8 & 255);
        }, t.opaque = function(f) {
          const v = (255 | f.rgba) >>> 0;
          return [o, l, u] = i.toChannels(v), { css: d.toCss(o, l, u), rgba: v };
        }, t.opacity = a, t.multiplyOpacity = function(f, v) {
          return n = 255 & f.rgba, a(f, n * v / 255);
        }, t.toColorRGB = function(f) {
          return [f.rgba >> 24 & 255, f.rgba >> 16 & 255, f.rgba >> 8 & 255];
        };
      }(_ || (s.color = _ = {})), function(t) {
        let a, f;
        try {
          const v = document.createElement("canvas");
          v.width = 1, v.height = 1;
          const p = v.getContext("2d", { willReadFrequently: !0 });
          p && (a = p, a.globalCompositeOperation = "copy", f = a.createLinearGradient(0, 0, 1, 1));
        } catch {
        }
        t.toColor = function(v) {
          if (v.match(/#[\da-f]{3,8}/i)) switch (v.length) {
            case 4:
              return o = parseInt(v.slice(1, 2).repeat(2), 16), l = parseInt(v.slice(2, 3).repeat(2), 16), u = parseInt(v.slice(3, 4).repeat(2), 16), d.toColor(o, l, u);
            case 5:
              return o = parseInt(v.slice(1, 2).repeat(2), 16), l = parseInt(v.slice(2, 3).repeat(2), 16), u = parseInt(v.slice(3, 4).repeat(2), 16), n = parseInt(v.slice(4, 5).repeat(2), 16), d.toColor(o, l, u, n);
            case 7:
              return { css: v, rgba: (parseInt(v.slice(1), 16) << 8 | 255) >>> 0 };
            case 9:
              return { css: v, rgba: parseInt(v.slice(1), 16) >>> 0 };
          }
          const p = v.match(/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(,\s*(0|1|\d?\.(\d+))\s*)?\)/);
          if (p) return o = parseInt(p[1]), l = parseInt(p[2]), u = parseInt(p[3]), n = Math.round(255 * (p[5] === void 0 ? 1 : parseFloat(p[5]))), d.toColor(o, l, u, n);
          if (!a || !f) throw new Error("css.toColor: Unsupported css format");
          if (a.fillStyle = f, a.fillStyle = v, typeof a.fillStyle != "string") throw new Error("css.toColor: Unsupported css format");
          if (a.fillRect(0, 0, 1, 1), [o, l, u, n] = a.getImageData(0, 0, 1, 1).data, n !== 255) throw new Error("css.toColor: Unsupported css format");
          return { rgba: d.toRgba(o, l, u, n), css: v };
        };
      }(g || (s.css = g = {})), function(t) {
        function a(f, v, p) {
          const c = f / 255, m = v / 255, y = p / 255;
      ...
      }(h || (s.rgb = h = {})), function(t) {
        function a(v, p, c) {
          const m = v >> 24 & 255, y = v >> 16 & 255, k = v >> 8 & 255;
          let L = p >> 24 & 255, w = p >> 16 & 255, R = p >> 8 & 255, B = e(h.relativeLuminance2(L, w, R), h.relativeLuminance2(m, y, k));
          for (; B < c && (L > 0 || w > 0 || R > 0); ) L -= Math.max(0, Math.ceil(0.1 * L)), w -= Math.max(0, Math.ceil(0.1 * w)), R -= Math.max(0, Math.ceil(0.1 * R)), B = e(h.relativeLuminance2(L, w, R), h.relativeLuminance2(m, y, k));
          return (L << 24 | w << 16 | R << 8 | 255) >>> 0;
        }
        function f(v, p, c) {
          const m = v >> 24 & 255, y = v >> 16 & 255, k = v >> 8 & 255;
          let L = p >> 24 & 255, w = p >> 16 & 255, R = p >> 8 & 255, B = e(h.relativeLuminance2(L, w, R), h.relativeLuminance2(m, y, k));
          for (; B < c && (L < 255 || w < 255 || R < 255); ) L = Math.min(255, L + Math.ceil(0.1 * (255 - L))), w = Math.min(255, w + Math.ceil(0.1 * (255 - w))), R = Math.min(255, R + Math.ceil(0.1 * (255 - R))), B = e(h.relativeLuminance2(L, w, R), h.relativeLuminance2(m, y, k));
          return (L << 24 | w << 16 | R << 8 | 255) >>> 0;
        }
        t.blend = function(v, p) {
          if (n = (255 & p) / 255, n === 1) return p;
          const c = p >> 24 & 255, m = p >> 16 & 255, y = p >> 8 & 255, k = v >> 24 & 255, L = v >> 16 & 255, w = v >> 8 & 255;
          return o = k + Math.round((c - k) * n), l = L + Math.round((m - L) * n), u = w + Math.round((y - w) * n), d.toRgba(o, l, u);
        }, t.ensureContrastRatio = function(v, p, c) {
          const m = h.relativeLuminance(v >> 8), y = h.relativeLuminance(p >> 8);
          if (e(m, y) < c) {
            if (y < m) {
              const w = a(v, p, c), R = e(m, h.relativeLuminance(w >> 8));
              if (R < c) {
                const B = f(v, p, c);
                return R > e(m, h.relativeLuminance(B >> 8)) ? w : B;
              }
              return w;
            }
            const k = f(v, p, c), L = e(m, h.relativeLuminance(k >> 8));
            if (L < c) {
              const w = a(v, p, c);
        ...
        }, t.reduceLuminance = a, t.increaseLuminance = f, t.toChannels = function(v) {
          return [v >> 24 & 255, v >> 16 & 255, v >> 8 & 255, 255 & v];
        };
      }(i || (s.rgba = i = {})), s.toPaddedHex = r, s.contrastRatio = e;
    }, 8969: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.CoreTerminal = void 0;
      const l = o(844), u = o(2585), n = o(4348), d = o(7866), _ = o(744), g = o(7302), h = o(6975), i = o(8460), r = o(1753), e = o(1480), t = o(7994), a = o(9282), f = o(5435), v = o(5981), p = o(2660);
      let c = !1;
      class m extends l.Disposable {
        ...
        _enableWindowsWrappingHeuristics() {
          if (!this._windowsWrappingHeuristics.value) {
            const k = [];
            k.push(this.onLineFeed(a.updateWindowsModeWrappedState.bind(null, this._bufferService))), k.push(this.registerCsiHandler({ final: "H" }, () => ((0, a.updateWindowsModeWrappedState)(this._bufferService), !1))), this._windowsWrappingHeuristics.value = (0, l.toDisposable)(() => {
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.runAndSubscribe = s.forwardEvent = s.EventEmitter = void 0, s.EventEmitter = class {
        constructor() {
        ...
        fire(o, l) {
          const u = [];
          for (let n = 0; n < this._listeners.length; n++) u.push(this._listeners[n]);
          for (let n = 0; n < u.length; n++) u[n].call(void 0, o, l);
        }
        dispose() {
        ...
        return o((u) => l.fire(u));
      }, s.runAndSubscribe = function(o, l) {
        return l(void 0), o((u) => l(u));
      };
    }, 5435: function(T, s, o) {
      var l = this && this.__decorate || function(I, S, b, E) {
        var x, M = arguments.length, H = M < 3 ? S : E === null ? E = Object.getOwnPropertyDescriptor(S, b) : E;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") H = Reflect.decorate(I, S, b, E);
        else for (var $ = I.length - 1; $ >= 0; $--) (x = I[$]) && (H = (M < 3 ? x(H) : M > 3 ? x(S, b, H) : x(S, b)) || H);
        return M > 3 && H && Object.defineProperty(S, b, H), H;
      }, u = this && this.__param || function(I, S) {
        return function(b, E) {
          S(b, E, I);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.InputHandler = s.WindowsOptionsReportType = void 0;
      const n = o(2584), d = o(7116), _ = o(2015), g = o(844), h = o(482), i = o(8437), r = o(8460), e = o(643), t = o(511), a = o(3734), f = o(2585), v = o(1480), p = o(6242), c = o(6351), m = o(5941), y = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, k = 131072;
      function L(I, S) {
        if (I > 24) return S.setWinLines || !1;
        switch (I) {
          case 1:
            return !!S.restoreWin;
          case 2:
      ...
      class B extends g.Disposable {
        ...
        parse(S, b) {
          let E, x = this._activeBuffer.x, M = this._activeBuffer.y, H = 0;
          ...
          if ($) {
            ...
            x = this._parseStack.cursorStartX, M = this._parseStack.cursorStartY, this._parseStack.paused = !1, S.length > k && (H = this._parseStack.position + k);
          }
          if (this._logService.logLevel <= f.LogLevelEnum.DEBUG && this._logService.debug("parsing data" + (typeof S == "string" ? ` "${S}"` : ` "${Array.prototype.map.call(S, (C) => String.fromCharCode(C)).join("")}"`), typeof S == "string" ? S.split("").map((C) => C.charCodeAt(0)) : S), this._parseBuffer.length < S.length && this._parseBuffer.length < k && (this._parseBuffer = new Uint32Array(Math.min(S.length, k))), $ || this._dirtyRowTracker.clearRange(), S.length > k) for (let C = H; C < S.length; C += k) {
            const O = C + k < S.length ? C + k : S.length, A = typeof S == "string" ? this._stringDecoder.decode(S.substring(C, O), this._parseBuffer) : this._utf8Decoder.decode(S.subarray(C, O), this._parseBuffer);
            if (E = this._parser.parse(this._parseBuffer, A)) return this._preserveStack(x, M, A, C), this._logSlowResolvingAsync(E), E;
          }
          else if (!$) {
            const C = typeof S == "string" ? this._stringDecoder.decode(S, this._parseBuffer) : this._utf8Decoder.decode(S, this._parseBuffer);
            if (E = this._parser.parse(this._parseBuffer, C)) return this._preserveStack(x, M, C, 0), this._logSlowResolvingAsync(E), E;
          }
          this._activeBuffer.x === x && this._activeBuffer.y === M || this._onCursorMove.fire();
          const j = this._dirtyRowTracker.end + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp), D = this._dirtyRowTracker.start + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp);
          D < this._bufferService.rows && this._onRequestRefreshRows.fire(Math.min(D, this._bufferService.rows - 1), Math.min(j, this._bufferService.rows - 1));
        }
        print(S, b, E) {
          let x, M;
          const H = this._charsetService.charset, $ = this._optionsService.rawOptions.screenReaderMode, j = this._bufferService.cols, D = this._coreService.decPrivateModes.wraparound, C = this._coreService.modes.insertMode, O = this._curAttrData;
          let A = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && E - b > 0 && A.getWidth(this._activeBuffer.x - 1) === 2 && A.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, O);
          let U = this._parser.precedingJoinState;
          for (let F = b; F < E; ++F) {
            if (x = S[F], x < 127 && H) {
              const G = H[String.fromCharCode(x)];
              G && (x = G.charCodeAt(0));
            }
            const q = this._unicodeService.charProperties(x, U);
            M = v.UnicodeService.extractWidth(q);
            const X = v.UnicodeService.extractShouldJoin(q), N = X ? v.UnicodeService.extractWidth(U) : 0;
            if (U = q, $ && this._onA11yChar.fire((0, h.stringFromCodePoint)(x)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + M - N > j) {
              if (D) {
                const G = A;
                let z = this._activeBuffer.x - N;
                for (this._activeBuffer.x = N, this._activeBuffer.y++, this._activeBuffer.y === this._activeBuffer.scrollBottom + 1 ? (this._activeBuffer.y--, this._bufferService.scroll(this._eraseAttrData(), !0)) : (this._activeBuffer.y >= this._bufferService.rows && (this._activeBuffer.y = this._bufferService.rows - 1), this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = !0), A = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y), N > 0 && A instanceof i.BufferLine && A.copyCellsFrom(G, z, 0, N, !1); z < j; ) G.setCellFromCodepoint(z++, 0, 1, O);
              } else if (this._activeBuffer.x = j - 1, M === 2) continue;
            }
            if (X && this._activeBuffer.x) {
              const G = A.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
              A.addCodepointToCell(this._activeBuffer.x - G, x, M);
              for (let z = M - N; --z >= 0; ) A.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, O);
            } else if (C && (A.insertCells(this._activeBuffer.x, M - N, this._activeBuffer.getNullCell(O)), A.getWidth(j - 1) === 2 && A.setCellFromCodepoint(j - 1, e.NULL_CELL_CODE, e.NULL_CELL_WIDTH, O)), A.setCellFromCodepoint(this._activeBuffer.x++, x, M, O), M > 0) for (; --M; ) A.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, O);
          }
          this._parser.precedingJoinState = U, this._activeBuffer.x < j && E - b > 0 && A.getWidth(this._activeBuffer.x) === 0 && !A.hasContent(this._activeBuffer.x) && A.setCellFromCodepoint(this._activeBuffer.x, 0, 1, O), this._dirtyRowTracker.markDirty(this._activeBuffer.y);
        }
        ...
        cursorUp(S) {
          ...
          return b >= 0 ? this._moveCursor(0, -Math.min(b, S.params[0] || 1)) : this._moveCursor(0, -(S.params[0] || 1)), !0;
        }
        cursorDown(S) {
        ...
        _eraseInBufferLine(S, b, E, x = !1, M = !1) {
          const H = this._activeBuffer.lines.get(this._activeBuffer.ybase + S);
          H.replaceCells(b, E, this._activeBuffer.getNullCell(this._eraseAttrData()), M), x && (H.isWrapped = !1);
        }
        _resetBufferLine(S, b = !1) {
          const E = this._activeBuffer.lines.get(this._activeBuffer.ybase + S);
          E && (E.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), b), this._bufferService.buffer.clearMarkers(this._activeBuffer.ybase + S), E.isWrapped = !1);
        }
        eraseInDisplay(S, b = !1) {
          let E;
          switch (this._restrictCursor(this._bufferService.cols), S.params[0]) {
            case 0:
              ...
              break;
            case 1:
              for (E = this._activeBuffer.y, this._dirtyRowTracker.markDirty(E), this._eraseInBufferLine(E, 0, this._activeBuffer.x + 1, !0, b), this._activeBuffer.x + 1 >= this._bufferService.cols && (this._activeBuffer.lines.get(E + 1).isWrapped = !1); E--; ) this._resetBufferLine(E, b);
            ...
            case 2:
              ...
              break;
            case 3:
              const x = this._activeBuffer.lines.length - this._bufferService.rows;
              x > 0 && (this._activeBuffer.lines.trimStart(x), this._activeBuffer.ybase = Math.max(this._activeBuffer.ybase - x, 0), this._activeBuffer.ydisp = Math.max(this._activeBuffer.ydisp - x, 0), this._onScroll.fire(0));
          }
          return !0;
        }
        eraseInLine(S, b = !1) {
        ...
        insertLines(S) {
          ...
          const E = this._activeBuffer.ybase + this._activeBuffer.y, x = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, M = this._bufferService.rows - 1 + this._activeBuffer.ybase - x + 1;
          for (; b--; ) this._activeBuffer.lines.splice(M - 1, 1), this._activeBuffer.lines.splice(E, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
        ...
        deleteLines(S) {
          ...
          let x;
          for (x = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, x = this._bufferService.rows - 1 + this._activeBuffer.ybase - x; b--; ) this._activeBuffer.lines.splice(E, 1), this._activeBuffer.lines.splice(x, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.y, this._activeBuffer.scrollBottom), this._activeBuffer.x = 0, !0;
        }
        insertChars(S) {
          this._restrictCursor();
          const b = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return b && (b.insertCells(this._activeBuffer.x, S.params[0] || 1, this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), !0;
        }
        deleteChars(S) {
          this._restrictCursor();
          const b = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return b && (b.deleteCells(this._activeBuffer.x, S.params[0] || 1, this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), !0;
        }
        scrollUp(S) {
          let b = S.params[0] || 1;
        ...
        scrollLeft(S) {
          ...
          for (let E = this._activeBuffer.scrollTop; E <= this._activeBuffer.scrollBottom; ++E) {
            const x = this._activeBuffer.lines.get(this._activeBuffer.ybase + E);
            x.deleteCells(0, b, this._activeBuffer.getNullCell(this._eraseAttrData())), x.isWrapped = !1;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
        }
        scrollRight(S) {
          ...
          for (let E = this._activeBuffer.scrollTop; E <= this._activeBuffer.scrollBottom; ++E) {
            const x = this._activeBuffer.lines.get(this._activeBuffer.ybase + E);
            x.insertCells(0, b, this._activeBuffer.getNullCell(this._eraseAttrData())), x.isWrapped = !1;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
        }
        insertColumns(S) {
          ...
          for (let E = this._activeBuffer.scrollTop; E <= this._activeBuffer.scrollBottom; ++E) {
            const x = this._activeBuffer.lines.get(this._activeBuffer.ybase + E);
            x.insertCells(this._activeBuffer.x, b, this._activeBuffer.getNullCell(this._eraseAttrData())), x.isWrapped = !1;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
        }
        deleteColumns(S) {
          ...
          for (let E = this._activeBuffer.scrollTop; E <= this._activeBuffer.scrollBottom; ++E) {
            const x = this._activeBuffer.lines.get(this._activeBuffer.ybase + E);
            x.deleteCells(this._activeBuffer.x, b, this._activeBuffer.getNullCell(this._eraseAttrData())), x.isWrapped = !1;
          }
          return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
        }
        eraseChars(S) {
          this._restrictCursor();
          const b = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          return b && (b.replaceCells(this._activeBuffer.x, this._activeBuffer.x + (S.params[0] || 1), this._activeBuffer.getNullCell(this._eraseAttrData())), this._dirtyRowTracker.markDirty(this._activeBuffer.y)), !0;
        }
        repeatPrecedingCharacter(S) {
          const b = this._parser.precedingJoinState;
          if (!b) return !0;
          const E = S.params[0] || 1, x = v.UnicodeService.extractWidth(b), M = this._activeBuffer.x - x, H = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(M), $ = new Uint32Array(H.length * E);
          let j = 0;
          for (let C = 0; C < H.length; ) {
            const O = H.codePointAt(C) || 0;
            $[j++] = O, C += O > 65535 ? 2 : 1;
          }
          let D = j;
          for (let C = 1; C < E; ++C) $.copyWithin(D, 0, j), D += j;
          return this.print($, 0, D), !0;
        }
        ...
        resetModePrivate(S) {
          for (let b = 0; b < S.length; b++) switch (S.params[b]) {
            ...
            case 47:
            case 1047:
              this._bufferService.buffers.activateNormalBuffer(), S.params[b] === 1049 && this.restoreCursor(), this._coreService.isCursorInitialized = !0, this._onRequestRefreshRows.fire(0, this._bufferService.rows - 1), this._onRequestSyncScrollBar.fire();
              break;
            case 2004:
        ...
        requestMode(S, b) {
          const E = this._coreService.decPrivateModes, { activeProtocol: x, activeEncoding: M } = this._coreMouseService, H = this._coreService, { buffers: $, cols: j } = this._bufferService, { active: D, alt: C } = $, O = this._optionsService.rawOptions, A = (X) => X ? 1 : 2, U = S.params[0];
          return F = U, q = b ? U === 2 ? 4 : U === 4 ? A(H.modes.insertMode) : U === 12 ? 3 : U === 20 ? A(O.convertEol) : 0 : U === 1 ? A(E.applicationCursorKeys) : U === 3 ? O.windowOptions.setWinLines ? j === 80 ? 2 : j === 132 ? 1 : 0 : 0 : U === 6 ? A(E.origin) : U === 7 ? A(E.wraparound) : U === 8 ? 3 : U === 9 ? A(x === "X10") : U === 12 ? A(O.cursorBlink) : U === 25 ? A(!H.isCursorHidden) : U === 45 ? A(E.reverseWraparound) : U === 66 ? A(E.applicationKeypad) : U === 67 ? 4 : U === 1e3 ? A(x === "VT200") : U === 1002 ? A(x === "DRAG") : U === 1003 ? A(x === "ANY") : U === 1004 ? A(E.sendFocus) : U === 1005 ? 4 : U === 1006 ? A(M === "SGR") : U === 1015 ? 4 : U === 1016 ? A(M === "SGR_PIXELS") : U === 1048 ? 1 : U === 47 || U === 1047 || U === 1049 ? A(D === C) : U === 2004 ? A(E.bracketedPasteMode) : 0, H.triggerDataEvent(`${n.C0.ESC}[${b ? "" : "?"}${F};${q}$y`), !0;
          var F, q;
        }
        _updateAttrColor(S, b, E, x, M) {
          return b === 2 ? (S |= 50331648, S &= -16777216, S |= a.AttributeData.fromColorRGB([E, x, M])) : b === 5 && (S &= -50331904, S |= 33554432 | 255 & E), S;
        }
        _extractColor(S, b, E) {
          const x = [0, 0, -1, 0, 0, 0];
          let M = 0, H = 0;
          do {
            if (x[H + M] = S.params[b + H], S.hasSubParams(b + H)) {
              const $ = S.getSubParams(b + H);
              let j = 0;
              do
                x[1] === 5 && (M = 1), x[H + j + 1 + M] = $[j];
              while (++j < $.length && j + H + 1 + M < x.length);
              break;
            }
            if (x[1] === 5 && H + M >= 2 || x[1] === 2 && H + M >= 5) break;
            x[1] && (M = 1);
          } while (++H + b < S.length && H + M < x.length);
          for (let $ = 2; $ < x.length; ++$) x[$] === -1 && (x[$] = 0);
          switch (x[0]) {
            case 38:
              E.fg = this._updateAttrColor(E.fg, x[1], x[3], x[4], x[5]);
              break;
            case 48:
              E.bg = this._updateAttrColor(E.bg, x[1], x[3], x[4], x[5]);
              break;
            case 58:
              E.extended = E.extended.clone(), E.extended.underlineColor = this._updateAttrColor(E.extended.underlineColor, x[1], x[3], x[4], x[5]);
          }
          return H;
        }
        ...
        charAttributes(S) {
          ...
          for (let M = 0; M < b; M++) E = S.params[M], E >= 30 && E <= 37 ? (x.fg &= -50331904, x.fg |= 16777216 | E - 30) : E >= 40 && E <= 47 ? (x.bg &= -50331904, x.bg |= 16777216 | E - 40) : E >= 90 && E <= 97 ? (x.fg &= -50331904, x.fg |= 16777224 | E - 90) : E >= 100 && E <= 107 ? (x.bg &= -50331904, x.bg |= 16777224 | E - 100) : E === 0 ? this._processSGR0(x) : E === 1 ? x.fg |= 134217728 : E === 3 ? x.bg |= 67108864 : E === 4 ? (x.fg |= 268435456, this._processUnderline(S.hasSubParams(M) ? S.getSubParams(M)[0] : 1, x)) : E === 5 ? x.fg |= 536870912 : E === 7 ? x.fg |= 67108864 : E === 8 ? x.fg |= 1073741824 : E === 9 ? x.fg |= 2147483648 : E === 2 ? x.bg |= 134217728 : E === 21 ? this._processUnderline(2, x) : E === 22 ? (x.fg &= -134217729, x.bg &= -134217729) : E === 23 ? x.bg &= -67108865 : E === 24 ? (x.fg &= -268435457, this._processUnderline(0, x)) : E === 25 ? x.fg &= -536870913 : E === 27 ? x.fg &= -67108865 : E === 28 ? x.fg &= -1073741825 : E === 29 ? x.fg &= 2147483647 : E === 39 ? (x.fg &= -67108864, x.fg |= 16777215 & i.DEFAULT_ATTR_DATA.fg) : E === 49 ? (x.bg &= -67108864, x.bg |= 16777215 & i.DEFAULT_ATTR_DATA.bg) : E === 38 || E === 48 || E === 58 ? M += this._extractColor(S, M, x) : E === 53 ? x.bg |= 1073741824 : E === 55 ? x.bg &= -1073741825 : E === 59 ? (x.extended = x.extended.clone(), x.extended.underlineColor = -1, x.updateExtended()) : E === 100 ? (x.fg &= -67108864, x.fg |= 16777215 & i.DEFAULT_ATTR_DATA.fg, x.bg &= -67108864, x.bg |= 16777215 & i.DEFAULT_ATTR_DATA.bg) : this._logService.debug("Unknown SGR attribute: %d.", E);
          return !0;
        }
        deviceStatus(S) {
          switch (S.params[0]) {
        ...
        setScrollRegion(S) {
          const b = S.params[0] || 1;
          let E;
          return (S.length < 2 || (E = S.params[1]) > this._bufferService.rows || E === 0) && (E = this._bufferService.rows), E > b && (this._activeBuffer.scrollTop = b - 1, this._activeBuffer.scrollBottom = E - 1, this._setCursor(0, 0)), !0;
        }
        windowOptions(S) {
        ...
        setOrReportIndexedColor(S) {
          const b = [], E = S.split(";");
          for (; E.length > 1; ) {
            const x = E.shift(), M = E.shift();
            if (/^\d+$/.exec(x)) {
              const H = parseInt(x);
              if (W(H)) if (M === "?") b.push({ type: 0, index: H });
              else {
                const $ = (0, m.parseColor)(M);
                $ && b.push({ type: 1, index: H, color: $ });
              }
            }
          }
        ...
        _createHyperlink(S, b) {
          ...
          const E = S.split(":");
          let x;
          const M = E.findIndex((H) => H.startsWith("id="));
          return M !== -1 && (x = E[M].slice(3) || void 0), this._curAttrData.extended = this._curAttrData.extended.clone(), this._curAttrData.extended.urlId = this._oscLinkService.registerLink({ id: x, uri: b }), this._curAttrData.updateExtended(), !0;
        }
        _finishHyperlink() {
        ...
        _setOrReportSpecialColor(S, b) {
          const E = S.split(";");
          for (let x = 0; x < E.length && !(b >= this._specialColors.length); ++x, ++b) if (E[x] === "?") this._onColor.fire([{ type: 0, index: this._specialColors[b] }]);
          else {
            const M = (0, m.parseColor)(E[x]);
        ...
        restoreIndexedColor(S) {
          ...
          const b = [], E = S.split(";");
          for (let x = 0; x < E.length; ++x) if (/^\d+$/.exec(E[x])) {
            const M = parseInt(E[x]);
            W(M) && b.push({ type: 2, index: M });
          }
          return b.length && this._onColor.fire(b), !0;
        }
        restoreFgColor(S) {
        ...
        selectCharset(S) {
          return S.length !== 2 ? (this.selectDefaultCharset(), !0) : (S[0] === "/" || this._charsetService.setgCharset(y[S[0]], d.CHARSETS[S[1]] || d.DEFAULT_CHARSET), !0);
        }
        index() {
        ...
        screenAlignmentPattern() {
          ...
          for (let b = 0; b < this._bufferService.rows; ++b) {
            const E = this._activeBuffer.ybase + this._activeBuffer.y + b, x = this._activeBuffer.lines.get(E);
            x && (x.fill(S), x.isWrapped = !1);
          }
          return this._dirtyRowTracker.markAllDirty(), this._setCursor(0, 0), !0;
        }
        requestStatusString(S, b) {
          const E = this._bufferService.buffer, x = this._optionsService.rawOptions;
          return ((M) => (this._coreService.triggerDataEvent(`${n.C0.ESC}${M}${n.C0.ESC}\\`), !0))(S === '"q' ? `P1$r${this._curAttrData.isProtected() ? 1 : 0}"q` : S === '"p' ? 'P1$r61;1"p' : S === "r" ? `P1$r${E.scrollTop + 1};${E.scrollBottom + 1}r` : S === "m" ? "P1$r0m" : S === " q" ? `P1$r${{ block: 2, underline: 4, bar: 6 }[x.cursorStyle] - (x.cursorBlink ? 1 : 0)} q` : "P0$r");
        }
        markRangeDirty(S, b) {
      ...
      let P = class {
        ...
        markRangeDirty(I, S) {
          I > S && (R = I, I = S, S = R), I < this.start && (this.start = I), S > this.end && (this.end = S);
        }
        markAllDirty() {
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.getDisposeArrayDisposable = s.disposeArray = s.toDisposable = s.MutableDisposable = s.Disposable = void 0, s.Disposable = class {
        ...
        set value(l) {
          var u;
          this._isDisposed || l === this._value || ((u = this._value) == null || u.dispose(), this._value = l);
        }
        clear() {
          this.value = void 0;
        }
        dispose() {
          var l;
          this._isDisposed = !0, (l = this._value) == null || l.dispose(), this._value = void 0;
        }
      ...
      class o {
        ...
        set(u, n, d) {
          this._data[u] || (this._data[u] = {}), this._data[u][n] = d;
        }
        get(u, n) {
          return this._data[u] ? this._data[u][n] : void 0;
        }
        clear() {
          this._data = {};
        }
      ...
      s.TwoKeyMap = o, s.FourKeyMap = class {
        ...
        set(l, u, n, d, _) {
          this._data.get(l, u) || this._data.set(l, u, new o()), this._data.get(l, u).set(n, d, _);
        }
        get(l, u, n, d) {
          var _;
          return (_ = this._data.get(l, u)) == null ? void 0 : _.get(n, d);
        }
        clear() {
          this._data.clear();
        }
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.isChromeOS = s.isLinux = s.isWindows = s.isIphone = s.isIpad = s.isMac = s.getSafariVersion = s.isSafari = s.isLegacyEdge = s.isFirefox = s.isNode = void 0, s.isNode = typeof process < "u" && "title" in process;
      ...
      s.SortedList = class {
        ...
        delete(l) {
          ...
          if (u === void 0 || (o = this._search(u), o === -1) || this._getKey(this._array[o]) !== u) return !1;
          do
        ...
        *getKeyIterator(l) {
        ...
        _search(l) {
          let u = 0, n = this._array.length - 1;
          for (; n >= u; ) {
            let d = u + n >> 1;
            const _ = this._getKey(this._array[d]);
            if (_ > l) n = d - 1;
            else {
              if (!(_ < l)) {
      ...
      class u {
        ...
        _process(_) {
          ...
          let g = 0, h = 0, i = _.timeRemaining(), r = 0;
          for (; this._i < this._tasks.length; ) {
            if (g = Date.now(), this._tasks[this._i]() || this._i++, g = Math.max(1, Date.now() - g), h = Math.max(g, h), r = _.timeRemaining(), 1.5 * h > r) return i - g < -20 && console.warn(`task queue exceeded allotted deadline by ${Math.abs(Math.round(i - g))}ms`), void this._start();
            i = r;
          }
          this.clear();
        }
      ...
      s.PriorityTaskQueue = n, s.IdleTaskQueue = !l.isNode && "requestIdleCallback" in window ? class extends u {
        _requestCallback(d) {
      ...
      const l = o(643);
      s.updateWindowsModeWrappedState = function(u) {
        const n = u.buffer.lines.get(u.buffer.ybase + u.buffer.y - 1), d = n == null ? void 0 : n.get(u.cols - 1), _ = u.buffer.lines.get(u.buffer.ybase + u.buffer.y);
        _ && d && (_.isWrapped = d[l.CHAR_DATA_CODE_INDEX] !== l.NULL_CELL_CODE && d[l.CHAR_DATA_CODE_INDEX] !== l.WHITESPACE_CELL_CODE);
      };
    }, 3734: (T, s) => {
      ...
      s.MAX_BUFFER_SIZE = 4294967295, s.Buffer = class {
        ...
        resize(e, t) {
          ...
          let f = 0;
          const v = this._getCorrectBufferLength(t);
          if (v > this.lines.maxLength && (this.lines.maxLength = v), this.lines.length > 0) {
            if (this._cols < e) for (let c = 0; c < this.lines.length; c++) f += +this.lines.get(c).resize(e, a);
            let p = 0;
            if (this._rows < t) for (let c = this._rows; c < t; c++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new d.BufferLine(e, a)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + p + 1 ? (this.ybase--, p++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new d.BufferLine(e, a)));
            ...
            if (v < this.lines.maxLength) {
              const c = this.lines.length - v;
              c > 0 && (this.lines.trimStart(c), this.ybase = Math.max(this.ybase - c, 0), this.ydisp = Math.max(this.ydisp - c, 0), this.savedY = Math.max(this.savedY - c, 0)), this.lines.maxLength = v;
            }
            this.x = Math.min(this.x, e - 1), this.y = Math.min(this.y, t - 1), p && (this.y += p), this.savedX = Math.min(this.savedX, e - 1), this.scrollTop = 0;
          }
          if (this.scrollBottom = t - 1, this._isReflowEnabled && (this._reflow(e, t), this._cols > e)) for (let p = 0; p < this.lines.length; p++) f += +this.lines.get(p).resize(e, a);
        ...
        _reflowLarger(e, t) {
          const a = (0, _.reflowLargerGetLinesToRemove)(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(d.DEFAULT_ATTR_DATA));
          if (a.length > 0) {
        ...
        _reflowLargerAdjustViewport(e, t, a) {
          ...
          let v = a;
          for (; v-- > 0; ) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new d.BufferLine(e, f))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
          this.savedY = Math.max(this.savedY - a, 0);
        }
        _reflowSmaller(e, t) {
          const a = this.getNullCell(d.DEFAULT_ATTR_DATA), f = [];
          let v = 0;
          for (let p = this.lines.length - 1; p >= 0; p--) {
            ...
            const k = m[m.length - 1].getTrimmedLength(), L = (0, _.reflowSmallerGetNewLineLengths)(m, this._cols, e), w = L.length - m.length;
            let R;
            R = this.ybase === 0 && this.y !== this.lines.length - 1 ? Math.max(0, this.y - this.lines.maxLength + w) : Math.max(0, this.lines.length - this.lines.maxLength + w);
            const B = [];
            for (let E = 0; E < w; E++) {
              const x = this.getBlankLine(d.DEFAULT_ATTR_DATA, !0);
              B.push(x);
            }
            B.length > 0 && (f.push({ start: p + m.length + v, newLines: B }), v += B.length), m.push(...B);
            let P = L.length - 1, W = L[P];
            W === 0 && (P--, W = L[P]);
            let I = m.length - w - 1, S = k;
            for (; I >= 0; ) {
              const E = Math.min(S, W);
              if (m[P] === void 0) break;
              if (m[P].copyCellsFrom(m[I], S - E, W - E, E, !0), W -= E, W === 0 && (P--, W = L[P]), S -= E, S === 0) {
                I--;
                const x = Math.max(I, 0);
                S = (0, _.getWrappedLineTrimmedLength)(m, x, this._cols);
              }
            }
            for (let E = 0; E < m.length; E++) L[E] < e && m[E].setCell(L[E], a);
            let b = w - R;
            for (; b-- > 0; ) this.ybase === 0 ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + v) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
          ...
          if (f.length > 0) {
            ...
            let w = 0;
            for (let P = Math.min(this.lines.maxLength - 1, m + v - 1); P >= 0; P--) if (L && L.start > y + w) {
              for (let W = L.newLines.length - 1; W >= 0; W--) this.lines.set(P--, L.newLines[W]);
              P++, p.push({ index: y + 1, amount: L.newLines.length }), w += L.newLines.length, L = f[++k];
            } else this.lines.set(P, c[y--]);
            let R = 0;
            for (let P = p.length - 1; P >= 0; P--) p[P].index += R, this.lines.onInsertEmitter.fire(p[P]), R += p[P].amount;
            const B = Math.max(0, m + v - this.lines.maxLength);
            B > 0 && this.lines.onTrimEmitter.fire(B);
          }
        }
        translateBufferLineToString(e, t, a = 0, f) {
          const v = this.lines.get(e);
          return v ? v.translateToString(t, a, f) : "";
        }
      ...
      const l = o(3734), u = o(511), n = o(643), d = o(482);
      ...
      class g {
        constructor(i, r, e = !1) {
          ...
          const t = r || u.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]);
          for (let a = 0; a < i; ++a) this.setCell(a, t);
          this.length = i;
        }
        get(i) {
          const r = this._data[3 * i + 0], e = 2097151 & r;
          return [this._data[3 * i + 1], 2097152 & r ? this._combined[i] : e ? (0, d.stringFromCodePoint)(e) : "", r >> 22, 2097152 & r ? this._combined[i].charCodeAt(this._combined[i].length - 1) : e];
        }
        set(i, r) {
          this._data[3 * i + 1] = r[n.CHAR_DATA_ATTR_INDEX], r[n.CHAR_DATA_CHAR_INDEX].length > 1 ? (this._combined[i] = r[1], this._data[3 * i + 0] = 2097152 | i | r[n.CHAR_DATA_WIDTH_INDEX] << 22) : this._data[3 * i + 0] = r[n.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | r[n.CHAR_DATA_WIDTH_INDEX] << 22;
        }
        getWidth(i) {
        ...
        getCodePoint(i) {
          const r = this._data[3 * i + 0];
          return 2097152 & r ? this._combined[i].charCodeAt(this._combined[i].length - 1) : 2097151 & r;
        }
        isCombined(i) {
        ...
        getString(i) {
          const r = this._data[3 * i + 0];
          return 2097152 & r ? this._combined[i] : 2097151 & r ? (0, d.stringFromCodePoint)(2097151 & r) : "";
        }
        isProtected(i) {
          return 536870912 & this._data[3 * i + 2];
        }
        loadCell(i, r) {
          return _ = 3 * i, r.content = this._data[_ + 0], r.fg = this._data[_ + 1], r.bg = this._data[_ + 2], 2097152 & r.content && (r.combinedData = this._combined[i]), 268435456 & r.bg && (r.extended = this._extendedAttrs[i]), r;
        }
        setCell(i, r) {
          2097152 & r.content && (this._combined[i] = r.combinedData), 268435456 & r.bg && (this._extendedAttrs[i] = r.extended), this._data[3 * i + 0] = r.content, this._data[3 * i + 1] = r.fg, this._data[3 * i + 2] = r.bg;
        }
        setCellFromCodepoint(i, r, e, t) {
          268435456 & t.bg && (this._extendedAttrs[i] = t.extended), this._data[3 * i + 0] = r | e << 22, this._data[3 * i + 1] = t.fg, this._data[3 * i + 2] = t.bg;
        }
        addCodepointToCell(i, r, e) {
          let t = this._data[3 * i + 0];
          2097152 & t ? this._combined[i] += (0, d.stringFromCodePoint)(r) : 2097151 & t ? (this._combined[i] = (0, d.stringFromCodePoint)(2097151 & t) + (0, d.stringFromCodePoint)(r), t &= -2097152, t |= 2097152) : t = r | 4194304, e && (t &= -12582913, t |= e << 22), this._data[3 * i + 0] = t;
        }
        insertCells(i, r, e) {
          if ((i %= this.length) && this.getWidth(i - 1) === 2 && this.setCellFromCodepoint(i - 1, 0, 1, e), r < this.length - i) {
            const t = new u.CellData();
            for (let a = this.length - i - r - 1; a >= 0; --a) this.setCell(i + r + a, this.loadCell(i + a, t));
            for (let a = 0; a < r; ++a) this.setCell(i + a, e);
        ...
        deleteCells(i, r, e) {
          if (i %= this.length, r < this.length - i) {
            const t = new u.CellData();
            for (let a = 0; a < this.length - i - r; ++a) this.setCell(i + a, this.loadCell(i + r + a, t));
            for (let a = this.length - r; a < this.length; ++a) this.setCell(a, e);
          } else for (let t = i; t < this.length; ++t) this.setCell(t, e);
        ...
        replaceCells(i, r, e, t = !1) {
          if (t) for (i && this.getWidth(i - 1) === 2 && !this.isProtected(i - 1) && this.setCellFromCodepoint(i - 1, 0, 1, e), r < this.length && this.getWidth(r - 1) === 2 && !this.isProtected(r) && this.setCellFromCodepoint(r, 0, 1, e); i < r && i < this.length; ) this.isProtected(i) || this.setCell(i, e), i++;
          else for (i && this.getWidth(i - 1) === 2 && this.setCellFromCodepoint(i - 1, 0, 1, e), r < this.length && this.getWidth(r - 1) === 2 && this.setCellFromCodepoint(r, 0, 1, e); i < r && i < this.length; ) this.setCell(i++, e);
        }
        resize(i, r) {
          ...
          if (i > this.length) {
            ...
            for (let t = this.length; t < i; ++t) this.setCell(t, r);
          } else {
            this._data = this._data.subarray(0, e);
            const t = Object.keys(this._combined);
            for (let f = 0; f < t.length; f++) {
              const v = parseInt(t[f], 10);
              v >= i && delete this._combined[v];
            }
            const a = Object.keys(this._extendedAttrs);
            for (let f = 0; f < a.length; f++) {
              const v = parseInt(a[f], 10);
              v >= i && delete this._extendedAttrs[v];
            }
          }
        ...
        fill(i, r = !1) {
          if (r) for (let e = 0; e < this.length; ++e) this.isProtected(e) || this.setCell(e, i);
          else {
        ...
        copyFrom(i) {
          ...
          for (const r in i._combined) this._combined[r] = i._combined[r];
          this._extendedAttrs = {};
          for (const r in i._extendedAttrs) this._extendedAttrs[r] = i._extendedAttrs[r];
          this.isWrapped = i.isWrapped;
        }
        clone() {
          const i = new g(0);
          i._data = new Uint32Array(this._data), i.length = this.length;
          for (const r in this._combined) i._combined[r] = this._combined[r];
          for (const r in this._extendedAttrs) i._extendedAttrs[r] = this._extendedAttrs[r];
        ...
        copyCellsFrom(i, r, e, t, a) {
          const f = i._data;
          if (a) for (let p = t - 1; p >= 0; p--) {
            for (let c = 0; c < 3; c++) this._data[3 * (e + p) + c] = f[3 * (r + p) + c];
            268435456 & f[3 * (r + p) + 2] && (this._extendedAttrs[e + p] = i._extendedAttrs[r + p]);
          }
          else for (let p = 0; p < t; p++) {
            for (let c = 0; c < 3; c++) this._data[3 * (e + p) + c] = f[3 * (r + p) + c];
            268435456 & f[3 * (r + p) + 2] && (this._extendedAttrs[e + p] = i._extendedAttrs[r + p]);
          }
          const v = Object.keys(i._combined);
          for (let p = 0; p < v.length; p++) {
            const c = parseInt(v[p], 10);
            c >= r && (this._combined[c - r + e] = i._combined[c]);
          }
        }
        translateToString(i, r, e, t) {
          r = r ?? 0, e = e ?? this.length, i && (e = Math.min(e, this.getTrimmedLength())), t && (t.length = 0);
          let a = "";
          for (; r < e; ) {
            const f = this._data[3 * r + 0], v = 2097151 & f, p = 2097152 & f ? this._combined[r] : v ? (0, d.stringFromCodePoint)(v) : n.WHITESPACE_CELL_CHAR;
            if (a += p, t) for (let c = 0; c < p.length; ++c) t.push(r);
            r += f >> 22 || 1;
          }
          return t && t.push(r), a;
        }
      ...
      function o(l, u, n) {
        ...
        const d = !l[u].hasContent(n - 1) && l[u].getWidth(n - 1) === 1, _ = l[u + 1].getWidth(0) === 2;
        return d && _ ? n - 1 : n;
      }
      Object.defineProperty(s, "__esModule", { value: !0 }), s.getWrappedLineTrimmedLength = s.reflowSmallerGetNewLineLengths = s.reflowLargerApplyNewLayout = s.reflowLargerCreateNewLayout = s.reflowLargerGetLinesToRemove = void 0, s.reflowLargerGetLinesToRemove = function(l, u, n, d, _) {
        const g = [];
        for (let h = 0; h < l.length - 1; h++) {
          let i = h, r = l.get(++i);
          if (!r.isWrapped) continue;
          const e = [l.get(h)];
          for (; i < l.length && r.isWrapped; ) e.push(r), r = l.get(++i);
          if (d >= h && d < i) {
            h += e.length - 1;
            continue;
          }
          let t = 0, a = o(e, t, u), f = 1, v = 0;
          for (; f < e.length; ) {
            const c = o(e, f, u), m = c - v, y = n - a, k = Math.min(m, y);
            e[t].copyCellsFrom(e[f], v, a, k, !1), a += k, a === n && (t++, a = 0), v += k, v === c && (f++, v = 0), a === 0 && t !== 0 && e[t - 1].getWidth(n - 1) === 2 && (e[t].copyCellsFrom(e[t - 1], n - 1, a++, 1, !1), e[t - 1].setCell(n - 1, _));
          }
        ...
        return g;
      }, s.reflowLargerCreateNewLayout = function(l, u) {
        const n = [];
        let d = 0, _ = u[d], g = 0;
        for (let h = 0; h < l.length; h++) if (_ === h) {
          const i = u[++d];
          l.onDeleteEmitter.fire({ index: h - g, amount: i }), h += i - 1, g += i, _ = u[++d];
        } else n.push(h);
        return { layout: n, countRemoved: g };
      }, s.reflowLargerApplyNewLayout = function(l, u) {
        const n = [];
        for (let d = 0; d < u.length; d++) n.push(l.get(u[d]));
        for (let d = 0; d < n.length; d++) l.set(d, n[d]);
        l.length = u.length;
      }, s.reflowSmallerGetNewLineLengths = function(l, u, n) {
        const d = [], _ = l.map((r, e) => o(l, e, u)).reduce((r, e) => r + e);
        let g = 0, h = 0, i = 0;
        for (; i < _; ) {
          if (_ - i < n) {
            d.push(_ - i);
      ...
      const l = o(8460), u = o(844), n = o(9092);
      ...
      const l = o(482), u = o(643), n = o(3734);
      class d extends n.AttributeData {
        ...
        setFromCharData(g) {
          ...
          let h = !1;
          if (g[u.CHAR_DATA_CHAR_INDEX].length > 2) h = !0;
          else if (g[u.CHAR_DATA_CHAR_INDEX].length === 2) {
            const i = g[u.CHAR_DATA_CHAR_INDEX].charCodeAt(0);
            if (55296 <= i && i <= 56319) {
              const r = g[u.CHAR_DATA_CHAR_INDEX].charCodeAt(1);
              56320 <= r && r <= 57343 ? this.content = 1024 * (i - 55296) + r - 56320 + 65536 | g[u.CHAR_DATA_WIDTH_INDEX] << 22 : h = !0;
            } else h = !0;
          } else this.content = g[u.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | g[u.CHAR_DATA_WIDTH_INDEX] << 22;
          h && (this.combinedData = g[u.CHAR_DATA_CHAR_INDEX], this.content = 2097152 | g[u.CHAR_DATA_WIDTH_INDEX] << 22);
        }
        getAsCharData() {
          return [this.fg, this.getChars(), this.getWidth(), this.getCode()];
        }
      ...
      class n {
        ...
        constructor(_) {
          this.line = _, this.isDisposed = !1, this._disposables = [], this._id = n._nextId++, this._onDispose = this.register(new l.EventEmitter()), this.onDispose = this._onDispose.event;
        }
        dispose() {
...
`, n.VT = "\v", n.FF = "\f", n.CR = "\r", n.SO = "", n.SI = "", n.DLE = "", n.DC1 = "", n.DC2 = "", n.DC3 = "", n.DC4 = "", n.NAK = "", n.SYN = "", n.ETB = "", n.CAN = "", n.EM = "", n.SUB = "", n.ESC = "\x1B", n.FS = "", n.GS = "", n.RS = "", n.US = "", n.SP = " ", n.DEL = "";
      ...
      const l = o(2584), u = { 48: ["0", ")"], 49: ["1", "!"], 50: ["2", "@"], 51: ["3", "#"], 52: ["4", "$"], 53: ["5", "%"], 54: ["6", "^"], 55: ["7", "&"], 56: ["8", "*"], 57: ["9", "("], 186: [";", ":"], 187: ["=", "+"], 188: [",", "<"], 189: ["-", "_"], 190: [".", ">"], 191: ["/", "?"], 192: ["`", "~"], 219: ["[", "{"], 220: ["\\", "|"], 221: ["]", "}"], 222: ["'", '"'] };
      s.evaluateKeyboardEvent = function(n, d, _, g) {
        ...
        switch (n.keyCode) {
          ...
          case 9:
            ...
            break;
          case 13:
            h.key = n.altKey ? l.C0.ESC + l.C0.CR : l.C0.CR, h.cancel = !0;
            break;
          case 27:
            h.key = l.C0.ESC, n.altKey && (h.key = l.C0.ESC + l.C0.ESC), h.cancel = !0;
            break;
          case 37:
            if (n.metaKey) break;
            i ? (h.key = l.C0.ESC + "[1;" + (i + 1) + "D", h.key === l.C0.ESC + "[1;3D" && (h.key = l.C0.ESC + (_ ? "b" : "[1;5D"))) : h.key = d ? l.C0.ESC + "OD" : l.C0.ESC + "[D";
            break;
          case 39:
            if (n.metaKey) break;
            i ? (h.key = l.C0.ESC + "[1;" + (i + 1) + "C", h.key === l.C0.ESC + "[1;3C" && (h.key = l.C0.ESC + (_ ? "f" : "[1;5C"))) : h.key = d ? l.C0.ESC + "OC" : l.C0.ESC + "[C";
            break;
          case 38:
            if (n.metaKey) break;
            i ? (h.key = l.C0.ESC + "[1;" + (i + 1) + "A", _ || h.key !== l.C0.ESC + "[1;3A" || (h.key = l.C0.ESC + "[1;5A")) : h.key = d ? l.C0.ESC + "OA" : l.C0.ESC + "[A";
            break;
          case 40:
            if (n.metaKey) break;
            i ? (h.key = l.C0.ESC + "[1;" + (i + 1) + "B", _ || h.key !== l.C0.ESC + "[1;3B" || (h.key = l.C0.ESC + "[1;5B")) : h.key = d ? l.C0.ESC + "OB" : l.C0.ESC + "[B";
            break;
          case 45:
          ...
          case 123:
            ...
            break;
          default:
            if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey) if (_ && !g || !n.altKey || n.metaKey) !_ || n.altKey || n.ctrlKey || n.shiftKey || !n.metaKey ? n.key && !n.ctrlKey && !n.altKey && !n.metaKey && n.keyCode >= 48 && n.key.length === 1 ? h.key = n.key : n.key && n.ctrlKey && (n.key === "_" && (h.key = l.C0.US), n.key === "@" && (h.key = l.C0.NUL)) : n.keyCode === 65 && (h.type = 1);
            else {
              const r = u[n.keyCode], e = r == null ? void 0 : r[n.shiftKey ? 1 : 0];
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.Utf8ToUtf32 = s.StringToUtf32 = s.utf32ToString = s.stringFromCodePoint = void 0, s.stringFromCodePoint = function(o) {
      ...
      }, s.utf32ToString = function(o, l = 0, u = o.length) {
        let n = "";
        for (let d = l; d < u; ++d) {
          let _ = o[d];
        ...
        decode(o, l) {
          ...
          let n = 0, d = 0;
          if (this._interim) {
            const _ = o.charCodeAt(d++);
            56320 <= _ && _ <= 57343 ? l[n++] = 1024 * (this._interim - 55296) + _ - 56320 + 65536 : (l[n++] = this._interim, l[n++] = _), this._interim = 0;
          }
          for (let _ = d; _ < u; ++_) {
            const g = o.charCodeAt(_);
            if (55296 <= g && g <= 56319) {
              if (++_ >= u) return this._interim = g, n;
        ...
        decode(o, l) {
          const u = o.length;
          if (!u) return 0;
          let n, d, _, g, h = 0, i = 0, r = 0;
          if (this.interim[0]) {
            let a = !1, f = this.interim[0];
            f &= (224 & f) == 192 ? 31 : (240 & f) == 224 ? 15 : 7;
            let v, p = 0;
            for (; (v = 63 & this.interim[++p]) && p < 4; ) f <<= 6, f |= v;
            ...
            for (; r < m; ) {
              ...
              this.interim[p++] = v, f <<= 6, f |= 63 & v;
            }
            a || (c === 2 ? f < 128 ? r-- : l[h++] = f : c === 3 ? f < 2048 || f >= 55296 && f <= 57343 || f === 65279 || (l[h++] = f) : f < 65536 || f > 1114111 || (l[h++] = f)), this.interim.fill(0);
          }
          const e = u - 4;
          let t = r;
          for (; t < u; ) {
            for (; !(!(t < e) || 128 & (n = o[t]) || 128 & (d = o[t + 1]) || 128 & (_ = o[t + 2]) || 128 & (g = o[t + 3])); ) l[h++] = n, l[h++] = d, l[h++] = _, l[h++] = g, t += 4;
            if (n = o[t++], n < 128) l[h++] = n;
            else if ((224 & n) == 192) {
              if (t >= u) return this.interim[0] = n, h;
              if (d = o[t++], (192 & d) != 128) {
                t--;
                continue;
              }
              ...
              if (t >= u) return this.interim[0] = n, this.interim[1] = d, h;
              if (_ = o[t++], (192 & _) != 128) {
                t--;
                continue;
              }
              if (i = (15 & n) << 12 | (63 & d) << 6 | 63 & _, i < 2048 || i >= 55296 && i <= 57343 || i === 65279) continue;
              l[h++] = i;
            } else if ((248 & n) == 240) {
              if (t >= u) return this.interim[0] = n, h;
              if (d = o[t++], (192 & d) != 128) {
              ...
              if (t >= u) return this.interim[0] = n, this.interim[1] = d, this.interim[2] = _, h;
              if (g = o[t++], (192 & g) != 128) {
                t--;
                continue;
              }
              if (i = (7 & n) << 18 | (63 & d) << 12 | (63 & _) << 6 | 63 & g, i < 65536 || i > 1114111) continue;
              l[h++] = i;
            }
          }
          return h;
      ...
      s.UnicodeV6 = class {
        constructor() {
          if (this.version = "6", !d) {
            ...
            for (let _ = 0; _ < u.length; ++_) d.fill(0, u[_][0], u[_][1] + 1);
          }
        }
        wcwidth(_) {
          return _ < 32 ? 0 : _ < 127 ? 1 : _ < 65536 ? d[_] : function(g, h) {
            let i, r = 0, e = h.length - 1;
            if (g < h[0][0] || g > h[e][1]) return !1;
            for (; e >= r; ) if (i = r + e >> 1, g > h[i][1]) r = i + 1;
            else {
              if (!(g < h[i][0])) return !0;
              e = i - 1;
            }
        ...
        charProperties(_, g) {
          let h = this.wcwidth(_), i = h === 0 && g !== 0;
          if (i) {
            const r = l.UnicodeService.extractWidth(g);
            r === 0 ? i = !1 : r > h && (h = r);
          }
      ...
      class n extends u.Disposable {
        constructor(_) {
          super(), this._action = _, this._writeBuffer = [], this._callbacks = [], this._pendingData = 0, this._bufferOffset = 0, this._isSyncWriting = !1, this._syncCalls = 0, this._didUserInput = !1, this._onWriteParsed = this.register(new l.EventEmitter()), this.onWriteParsed = this._onWriteParsed.event;
        }
        handleUserInput() {
        ...
        write(_, g) {
          ...
          if (!this._writeBuffer.length) {
            if (this._bufferOffset = 0, this._didUserInput) return this._didUserInput = !1, this._pendingData += _.length, this._writeBuffer.push(_), this._callbacks.push(g), void this._innerWrite();
            setTimeout(() => this._innerWrite());
          }
          this._pendingData += _.length, this._writeBuffer.push(_), this._callbacks.push(g);
        }
        _innerWrite(_ = 0, g = !0) {
          const h = _ || Date.now();
          for (; this._writeBuffer.length > this._bufferOffset; ) {
            const i = this._writeBuffer[this._bufferOffset], r = this._action(i, g);
            if (r) {
      ...
      function u(n, d) {
        const _ = n.toString(16), g = _.length < 2 ? "0" + _ : _;
        switch (d) {
          case 4:
            return _[0];
          case 8:
      ...
      s.parseColor = function(n) {
        ...
        if (d.indexOf("rgb:") === 0) {
          ...
          const _ = o.exec(d);
          if (_) {
            const g = _[1] ? 15 : _[4] ? 255 : _[7] ? 4095 : 65535;
            return [Math.round(parseInt(_[1] || _[4] || _[7] || _[10], 16) / g * 255), Math.round(parseInt(_[2] || _[5] || _[8] || _[11], 16) / g * 255), Math.round(parseInt(_[3] || _[6] || _[9] || _[12], 16) / g * 255)];
          }
        } else if (d.indexOf("#") === 0 && (d = d.slice(1), l.exec(d) && [3, 6, 9, 12].includes(d.length))) {
          const _ = d.length / 3, g = [0, 0, 0];
          for (let h = 0; h < 3; ++h) {
            const i = parseInt(d.slice(_ * h, _ * h + _), 16);
            g[h] = _ === 1 ? i << 4 : _ === 2 ? i : _ === 3 ? i >> 4 : i >> 8;
          }
          return g;
        }
      }, s.toRgbString = function(n, d = 16) {
        const [_, g, h] = n;
        return `rgb:${u(_, d)}/${u(g, d)}/${u(h, d)}`;
      };
    }, 5770: (T, s) => {
      ...
      const l = o(482), u = o(8742), n = o(5770), d = [];
      s.DcsParser = class {
        constructor() {
        ...
        put(g, h, i) {
          if (this._active.length) for (let r = this._active.length - 1; r >= 0; r--) this._active[r].put(g, h, i);
          else this._handlerFb(this._ident, "PUT", (0, l.utf32ToString)(g, h, i));
        }
        unhook(g, h = !0) {
          if (this._active.length) {
            let i = !1, r = this._active.length - 1, e = !1;
            if (this._stack.paused && (r = this._stack.loopPosition - 1, i = h, e = this._stack.fallThrough, this._stack.paused = !1), !e && i === !1) {
              for (; r >= 0 && (i = this._active[r].unhook(g), i !== !0); r--) if (i instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = r, this._stack.fallThrough = !1, i;
              r--;
            }
      ...
      _.addParam(0), s.DcsHandler = class {
        constructor(g) {
          this._handler = g, this._data = "", this._params = _, this._hitLimit = !1;
        }
        hook(g) {
          this._params = g.length > 1 || g.params[0] ? g.clone() : _, this._data = "", this._hitLimit = !1;
        }
        put(g, h, i) {
          this._hitLimit || (this._data += (0, l.utf32ToString)(g, h, i), this._data.length > n.PAYLOAD_LIMIT && (this._data = "", this._hitLimit = !0));
        }
        unhook(g) {
          let h = !1;
          if (this._hitLimit) h = !1;
          else if (g && (h = this._handler(this._data, this._params), h instanceof Promise)) return h.then((i) => (this._params = _, this._data = "", this._hitLimit = !1, i));
      ...
      const l = o(844), u = o(8742), n = o(6242), d = o(6351);
      class _ {
        constructor(r) {
        ...
        add(r, e, t, a) {
          this.table[e << 8 | r] = t << 4 | a;
        }
        addMany(r, e, t, a) {
          for (let f = 0; f < r.length; f++) this.table[e << 8 | r[f]] = t << 4 | a;
        }
      }
      s.TransitionTable = _;
      const g = 160;
      s.VT500_TRANSITION_TABLE = function() {
        const i = new _(4095), r = Array.apply(null, Array(256)).map((p, c) => c), e = (p, c) => r.slice(p, c), t = e(32, 127), a = e(0, 24);
        a.push(25), a.push.apply(a, e(28, 32));
        const f = e(0, 14);
        let v;
        for (v in i.setDefault(1, 0), i.addMany(t, 0, 2, 0), f) i.addMany([24, 26, 153, 154], v, 3, 0), i.addMany(e(128, 144), v, 3, 0), i.addMany(e(144, 152), v, 3, 0), i.add(156, v, 0, 0), i.add(27, v, 11, 1), i.add(157, v, 4, 8), i.addMany([152, 158, 159], v, 0, 7), i.add(155, v, 11, 3), i.add(144, v, 11, 9);
      ...
      class h extends l.Disposable {
        constructor(r = s.VT500_TRANSITION_TABLE) {
          super(), this._transitions = r, this._parseStack = { state: 0, handlers: [], handlerPos: 0, transition: 0, chunkPos: 0 }, this.initialState = 0, this.currentState = this.initialState, this._params = new u.Params(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, a) => {
        ...
        _identifier(r, e = [64, 126]) {
          ...
          if (r.prefix) {
            ...
            if (t = r.prefix.charCodeAt(0), t && 60 > t || t > 63) throw new Error("prefix must be in range 0x3c .. 0x3f");
          }
          if (r.intermediates) {
        ...
        identToString(r) {
          const e = [];
          for (; r; ) e.push(String.fromCharCode(255 & r)), r >>= 8;
        ...
        _preserveStack(r, e, t, a, f) {
          this._parseStack.state = r, this._parseStack.handlers = e, this._parseStack.handlerPos = t, this._parseStack.transition = a, this._parseStack.chunkPos = f;
        }
        parse(r, e, t) {
          let a, f = 0, v = 0, p = 0;
          if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, p = this._parseStack.chunkPos + 1;
            ...
            switch (this._parseStack.state) {
              case 3:
                if (t === !1 && m > -1) {
                  for (; m >= 0 && (a = c[m](this._params), a !== !0); m--) if (a instanceof Promise) return this._parseStack.handlerPos = m, a;
                }
                this._parseStack.handlers = [];
                break;
              case 4:
                if (t === !1 && m > -1) {
                  for (; m >= 0 && (a = c[m](), a !== !0); m--) if (a instanceof Promise) return this._parseStack.handlerPos = m, a;
                }
                this._parseStack.handlers = [];
                break;
              case 6:
                if (f = r[this._parseStack.chunkPos], a = this._dcsParser.unhook(f !== 24 && f !== 26, t), a) return a;
                f === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
                break;
              case 5:
                if (f = r[this._parseStack.chunkPos], a = this._oscParser.end(f !== 24 && f !== 26, t), a) return a;
                f === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
            }
          ...
          for (let c = p; c < e; ++c) {
            switch (f = r[c], v = this._transitions.table[this.currentState << 8 | (f < 160 ? f : g)], v >> 4) {
              case 2:
                for (let w = c + 1; ; ++w) {
                  if (w >= e || (f = r[w]) < 32 || f > 126 && f < g) {
                    this._printHandler(r, c, w), c = w - 1;
                    break;
                  }
                  if (++w >= e || (f = r[w]) < 32 || f > 126 && f < g) {
                    this._printHandler(r, c, w), c = w - 1;
              ...
              case 0:
                break;
              case 1:
                if (this._errorHandler({ position: c, code: f, currentState: this.currentState, collect: this._collect, params: this._params, abort: !1 }).abort) return;
                break;
              case 7:
                const m = this._csiHandlers[this._collect << 8 | f];
                let y = m ? m.length - 1 : -1;
                for (; y >= 0 && (a = m[y](this._params), a !== !0); y--) if (a instanceof Promise) return this._preserveStack(3, m, y, v, c), a;
              ...
              case 10:
                ...
                for (; L >= 0 && (a = k[L](), a !== !0); L--) if (a instanceof Promise) return this._preserveStack(4, k, L, v, c), a;
              ...
              case 12:
                ...
                break;
              case 13:
                for (let w = c + 1; ; ++w) if (w >= e || (f = r[w]) === 24 || f === 26 || f === 27 || f > 127 && f < g) {
                  this._dcsParser.put(r, c, w), c = w - 1;
                  break;
                }
                break;
              case 14:
                if (a = this._dcsParser.unhook(f !== 24 && f !== 26), a) return this._preserveStack(6, [], 0, v, c), a;
                f === 27 && (v |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
                break;
              case 4:
                this._oscParser.start();
                break;
              case 5:
                for (let w = c + 1; ; w++) if (w >= e || (f = r[w]) < 32 || f > 127 && f < g) {
                  this._oscParser.put(r, c, w), c = w - 1;
                  break;
                }
                break;
              case 6:
                if (a = this._oscParser.end(f !== 24 && f !== 26), a) return this._preserveStack(5, [], 0, v, c), a;
                f === 27 && (v |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
            }
      ...
      s.OscParser = class {
        ...
        _put(d, _, g) {
          if (this._active.length) for (let h = this._active.length - 1; h >= 0; h--) this._active[h].put(d, _, g);
          else this._handlerFb(this._id, "PUT", (0, u.utf32ToString)(d, _, g));
        }
        start() {
        ...
        put(d, _, g) {
          if (this._state !== 3) {
            ...
            this._state === 2 && g - _ > 0 && this._put(d, _, g);
          }
        }
        end(d, _ = !0) {
          if (this._state !== 0) {
            if (this._state !== 3) if (this._state === 1 && this._start(), this._active.length) {
              let g = !1, h = this._active.length - 1, i = !1;
              if (this._stack.paused && (h = this._stack.loopPosition - 1, g = _, i = this._stack.fallThrough, this._stack.paused = !1), !i && g === !1) {
                for (; h >= 0 && (g = this._active[h].end(d), g !== !0); h--) if (g instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = h, this._stack.fallThrough = !1, g;
                h--;
              }
              for (; h >= 0; h--) if (g = this._active[h].end(!1), g instanceof Promise) return this._stack.paused = !0, this._stack.loopPosition = h, this._stack.fallThrough = !0, g;
        ...
        put(d, _, g) {
          this._hitLimit || (this._data += (0, u.utf32ToString)(d, _, g), this._data.length > l.PAYLOAD_LIMIT && (this._data = "", this._hitLimit = !0));
        }
        end(d) {
          let _ = !1;
          if (this._hitLimit) _ = !1;
          else if (d && (_ = this._handler(this._data), _ instanceof Promise)) return _.then((g) => (this._data = "", this._hitLimit = !1, g));
      ...
      class l {
        ...
        toArray() {
          ...
          for (let d = 0; d < this.length; ++d) {
            ...
            g - _ > 0 && n.push(Array.prototype.slice.call(this._subParams, _, g));
          }
          return n;
        }
        reset() {
        ...
        getSubParams(n) {
          const d = this._subParamsIdx[n] >> 8, _ = 255 & this._subParamsIdx[n];
          return _ - d > 0 ? this._subParams.subarray(d, _) : null;
        }
        getSubParamsAll() {
          const n = {};
          for (let d = 0; d < this.length; ++d) {
            const _ = this._subParamsIdx[d] >> 8, g = 255 & this._subParamsIdx[d];
            g - _ > 0 && (n[d] = this._subParams.slice(_, g));
          }
          return n;
        }
        addDigit(n) {
          ...
          const _ = this._digitIsSub ? this._subParams : this.params, g = _[d - 1];
          _[d - 1] = ~g ? Math.min(10 * g + n, o) : n;
        }
      }
      s.Params = l;
    }, 5741: (T, s) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.AddonManager = void 0, s.AddonManager = class {
        ...
        loadAddon(o, l) {
          ...
          this._addons.push(u), l.dispose = () => this._wrappedAddonDispose(u), l.activate(o);
        }
        _wrappedAddonDispose(o) {
          if (o.isDisposed) return;
          let l = -1;
          for (let u = 0; u < this._addons.length; u++) if (this._addons[u] === o) {
            l = u;
            break;
          }
      ...
      s.BufferLineApiView = class {
        ...
        getCell(u, n) {
          if (!(u < 0 || u >= this._line.length)) return n ? (this._line.loadCell(u, n), n) : this._line.loadCell(u, new l.CellData());
        }
        translateToString(u, n, d) {
          return this._line.translateToString(u, n, d);
        }
      };
    }, 8285: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.BufferNamespaceApi = void 0;
      const l = o(8771), u = o(8460), n = o(844);
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.ParserApi = void 0, s.ParserApi = class {
        ...
        registerDcsHandler(o, l) {
          return this._core.registerDcsHandler(o, (u, n) => l(u, n.toArray()));
        }
        addDcsHandler(o, l) {
      ...
      var l = this && this.__decorate || function(i, r, e, t) {
        var a, f = arguments.length, v = f < 3 ? r : t === null ? t = Object.getOwnPropertyDescriptor(r, e) : t;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") v = Reflect.decorate(i, r, e, t);
        else for (var p = i.length - 1; p >= 0; p--) (a = i[p]) && (v = (f < 3 ? a(v) : f > 3 ? a(r, e, v) : a(r, e)) || v);
        return f > 3 && v && Object.defineProperty(r, e, v), v;
      }, u = this && this.__param || function(i, r) {
        return function(e, t) {
          r(e, t, i);
        };
      };
      Object.defineProperty(s, "__esModule", { value: !0 }), s.BufferService = s.MINIMUM_ROWS = s.MINIMUM_COLS = void 0;
      const n = o(8460), d = o(844), _ = o(5295), g = o(2585);
      s.MINIMUM_COLS = 2, s.MINIMUM_ROWS = 1;
      let h = s.BufferService = class extends d.Disposable {
        get buffer() {
          return this.buffers.active;
        }
        constructor(i) {
          super(), this.isUserScrolling = !1, this._onResize = this.register(new n.EventEmitter()), this.onResize = this._onResize.event, this._onScroll = this.register(new n.EventEmitter()), this.onScroll = this._onScroll.event, this.cols = Math.max(i.rawOptions.cols || 0, s.MINIMUM_COLS), this.rows = Math.max(i.rawOptions.rows || 0, s.MINIMUM_ROWS), this.buffers = this.register(new _.BufferSet(i, this));
        }
        resize(i, r) {
          this.cols = i, this.rows = r, this.buffers.resize(i, r), this._onResize.fire({ cols: i, rows: r });
        }
        reset() {
        ...
        scroll(i, r = !1) {
          const e = this.buffer;
          let t;
          t = this._cachedBlankLine, t && t.length === this.cols && t.getFg(0) === i.fg && t.getBg(0) === i.bg || (t = e.getBlankLine(i, r), this._cachedBlankLine = t), t.isWrapped = r;
          const a = e.ybase + e.scrollTop, f = e.ybase + e.scrollBottom;
          if (e.scrollTop === 0) {
            const v = e.lines.isFull;
            f === e.lines.length - 1 ? v ? e.lines.recycle().copyFrom(t) : e.lines.push(t.clone()) : e.lines.splice(f + 1, 0, t.clone()), v ? this.isUserScrolling && (e.ydisp = Math.max(e.ydisp - 1, 0)) : (e.ybase++, this.isUserScrolling || e.ydisp++);
          } else {
            const v = f - a + 1;
            e.lines.shiftElements(a + 1, v - 1, -1), e.lines.set(f, t.clone());
          }
        ...
        scrollLines(i, r, e) {
          ...
          const a = t.ydisp;
          t.ydisp = Math.max(Math.min(t.ydisp + i, t.ybase), 0), a !== t.ydisp && (r || this._onScroll.fire(t.ydisp));
        }
      };
      s.BufferService = h = l([u(0, g.IOptionsService)], h);
    }, 7994: (T, s) => {
      ...
      const n = o(2585), d = o(8460), _ = o(844), g = { NONE: { events: 0, restrict: () => !1 }, X10: { events: 1, restrict: (t) => t.button !== 4 && t.action === 1 && (t.ctrl = !1, t.alt = !1, t.shift = !1, !0) }, VT200: { events: 19, restrict: (t) => t.action !== 32 }, DRAG: { events: 23, restrict: (t) => t.action !== 32 || t.button !== 3 }, ANY: { events: 31, restrict: (t) => !0 } };
      function h(t, a) {
      ...
      const i = String.fromCharCode, r = { DEFAULT: (t) => {
      ...
      let e = s.CoreMouseService = class extends _.Disposable {
        constructor(t, a) {
          super(), this._bufferService = t, this._coreService = a, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._onProtocolChange = this.register(new d.EventEmitter()), this.onProtocolChange = this._onProtocolChange.event;
          for (const f of Object.keys(g)) this.addProtocol(f, g[f]);
          for (const f of Object.keys(r)) this.addEncoding(f, r[f]);
          this.reset();
        }
        addProtocol(t, a) {
          this._protocols[t] = a;
      ...
      s.CoreMouseService = e = l([u(0, n.IBufferService), u(1, n.ICoreService)], e);
    }, 6975: function(T, s, o) {
      var l = this && this.__decorate || function(e, t, a, f) {
        var v, p = arguments.length, c = p < 3 ? t : f === null ? f = Object.getOwnPropertyDescriptor(t, a) : f;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") c = Reflect.decorate(e, t, a, f);
      ...
      const n = o(1439), d = o(8460), _ = o(844), g = o(2585), h = Object.freeze({ insertMode: !1 }), i = Object.freeze({ applicationCursorKeys: !1, applicationKeypad: !1, bracketedPasteMode: !1, origin: !1, reverseWraparound: !1, sendFocus: !1, wraparound: !0 });
      let r = s.CoreService = class extends _.Disposable {
        constructor(e, t, a) {
          super(), this._bufferService = e, this._logService = t, this._optionsService = a, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this.register(new d.EventEmitter()), this.onData = this._onData.event, this._onUserInput = this.register(new d.EventEmitter()), this.onUserInput = this._onUserInput.event, this._onBinary = this.register(new d.EventEmitter()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this.register(new d.EventEmitter()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = (0, n.clone)(h), this.decPrivateModes = (0, n.clone)(i);
        }
        reset() {
      ...
      s.CoreService = r = l([u(0, g.IBufferService), u(1, g.ILogService), u(2, g.IOptionsService)], r);
    }, 9074: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.DecorationService = void 0;
      const l = o(8055), u = o(8460), n = o(844), d = o(6106);
      let _ = 0, g = 0;
      class h extends n.Disposable {
        ...
        constructor() {
          super(), this._decorations = new d.SortedList((e) => e == null ? void 0 : e.marker.line), this._onDecorationRegistered = this.register(new u.EventEmitter()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this.register(new u.EventEmitter()), this.onDecorationRemoved = this._onDecorationRemoved.event, this.register((0, n.toDisposable)(() => this.reset()));
        }
        ...
        *getDecorationsAtCell(e, t, a) {
          let f = 0, v = 0;
          for (const p of this._decorations.getKeyIterator(t)) f = p.options.x ?? 0, v = f + (p.options.width ?? 1), e >= f && e < v && (!a || (p.options.layer ?? "bottom") === a) && (yield p);
        }
        forEachDecorationAtCell(e, t, a, f) {
          this._decorations.forEachByKey(t, (v) => {
            _ = v.options.x ?? 0, g = _ + (v.options.width ?? 1), e >= _ && e < g && (!a || (v.options.layer ?? "bottom") === a) && f(v);
          });
        }
      }
      s.DecorationService = h;
      class i extends n.Disposable {
        ...
        constructor(e) {
          super(), this.options = e, this.onRenderEmitter = this.register(new u.EventEmitter()), this.onRender = this.onRenderEmitter.event, this._onDispose = this.register(new u.EventEmitter()), this.onDispose = this._onDispose.event, this._cachedBg = null, this._cachedFg = null, this.marker = e.marker, this.options.overviewRulerOptions && !this.options.overviewRulerOptions.position && (this.options.overviewRulerOptions.position = "full");
        }
        dispose() {
      ...
      const l = o(2585), u = o(8343);
      class n {
        constructor(..._) {
          this._entries = /* @__PURE__ */ new Map();
          for (const [g, h] of _) this.set(g, h);
        }
        set(_, g) {
          const h = this._entries.get(_);
          return this._entries.set(_, g), h;
        }
        forEach(_) {
          for (const [g, h] of this._entries.entries()) _(g, h);
        }
        has(_) {
      ...
      s.ServiceCollection = n, s.InstantiationService = class {
        ...
        setService(d, _) {
          this._services.set(d, _);
        }
        getService(d) {
          return this._services.get(d);
        }
        createInstance(d, ..._) {
          const g = (0, u.getServiceDependencies)(d).sort((r, e) => r.index - e.index), h = [];
          for (const r of g) {
            const e = this._services.get(r.id);
            if (!e) throw new Error(`[createInstance] ${d.name} depends on UNKNOWN service ${r.id}.`);
            h.push(e);
          }
          const i = g.length > 0 ? g[0].index : _.length;
          if (_.length !== i) throw new Error(`[createInstance] First service dependency of ${d.name} at position ${i + 1} conflicts with ${_.length} static arguments`);
          return new d(..._, ...h);
        }
      };
    }, 7866: function(T, s, o) {
      ...
      const n = o(844), d = o(2585), _ = { trace: d.LogLevelEnum.TRACE, debug: d.LogLevelEnum.DEBUG, info: d.LogLevelEnum.INFO, warn: d.LogLevelEnum.WARN, error: d.LogLevelEnum.ERROR, off: d.LogLevelEnum.OFF };
      let g, h = s.LogService = class extends n.Disposable {
        get logLevel() {
        ...
        _evalLazyOptionalParams(i) {
          for (let r = 0; r < i.length; r++) typeof i[r] == "function" && (i[r] = i[r]());
        }
        _log(i, r, e) {
          this._evalLazyOptionalParams(e), i.call(console, (this._optionsService.options.logger ? "" : "xterm.js: ") + r, ...e);
        }
        trace(i, ...r) {
          var e;
          this._logLevel <= d.LogLevelEnum.TRACE && this._log(((e = this._optionsService.options.logger) == null ? void 0 : e.trace.bind(this._optionsService.options.logger)) ?? console.log, i, r);
        }
        debug(i, ...r) {
          var e;
          this._logLevel <= d.LogLevelEnum.DEBUG && this._log(((e = this._optionsService.options.logger) == null ? void 0 : e.debug.bind(this._optionsService.options.logger)) ?? console.log, i, r);
        }
        info(i, ...r) {
          var e;
          this._logLevel <= d.LogLevelEnum.INFO && this._log(((e = this._optionsService.options.logger) == null ? void 0 : e.info.bind(this._optionsService.options.logger)) ?? console.info, i, r);
        }
        warn(i, ...r) {
          var e;
          this._logLevel <= d.LogLevelEnum.WARN && this._log(((e = this._optionsService.options.logger) == null ? void 0 : e.warn.bind(this._optionsService.options.logger)) ?? console.warn, i, r);
        }
        error(i, ...r) {
          var e;
          this._logLevel <= d.LogLevelEnum.ERROR && this._log(((e = this._optionsService.options.logger) == null ? void 0 : e.error.bind(this._optionsService.options.logger)) ?? console.error, i, r);
        }
      };
      s.LogService = h = l([u(0, d.IOptionsService)], h), s.setTraceLogger = function(i) {
        g = i;
      }, s.traceCall = function(i, r, e) {
        if (typeof e.value != "function") throw new Error("not supported");
        const t = e.value;
        e.value = function(...a) {
          if (g.logLevel !== d.LogLevelEnum.TRACE) return t.apply(this, a);
          g.trace(`GlyphRenderer#${t.name}(${a.map((v) => JSON.stringify(v)).join(", ")})`);
          const f = t.apply(this, a);
          return g.trace(`GlyphRenderer#${t.name} return`, f), f;
        };
      };
    }, 7302: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.OptionsService = s.DEFAULT_OPTIONS = void 0;
      const l = o(8460), u = o(844), n = o(6114);
      s.DEFAULT_OPTIONS = { cols: 80, rows: 24, cursorBlink: !1, cursorStyle: "block", cursorWidth: 1, cursorInactiveStyle: "outline", customGlyphs: !0, drawBoldTextInBrightColors: !0, documentOverride: null, fastScrollModifier: "alt", fastScrollSensitivity: 5, fontFamily: "courier-new, courier, monospace", fontSize: 15, fontWeight: "normal", fontWeightBold: "bold", ignoreBracketedPasteMode: !1, lineHeight: 1, letterSpacing: 0, linkHandler: null, logLevel: "info", logger: null, scrollback: 1e3, scrollOnUserInput: !0, scrollSensitivity: 1, screenReaderMode: !1, smoothScrollDuration: 0, macOptionIsMeta: !1, macOptionClickForcesSelection: !1, minimumContrastRatio: 1, disableStdin: !1, allowProposedApi: !1, allowTransparency: !1, tabStopWidth: 8, theme: {}, rescaleOverlappingGlyphs: !1, rightClickSelectsWord: n.isMac, windowOptions: {}, windowsMode: !1, windowsPty: {}, wordSeparator: " ()[]{}',\"`", altClickMovesCursor: !0, convertEol: !1, termName: "xterm", cancelEvents: !1, overviewRulerWidth: 0 };
      ...
      class _ extends u.Disposable {
        constructor(h) {
          ...
          const i = { ...s.DEFAULT_OPTIONS };
          for (const r in h) if (r in i) try {
            const e = h[r];
            i[r] = this._sanitizeAndValidateOption(r, e);
          } catch (e) {
            console.error(e);
          }
          this.rawOptions = i, this.options = { ...i }, this._setupOptions(), this.register((0, u.toDisposable)(() => {
            this.rawOptions.linkHandler = null, this.rawOptions.documentOverride = null;
          }));
        }
        onSpecificOptionChange(h, i) {
          return this.onOptionChange((r) => {
            r === h && i(this.rawOptions[h]);
          });
        }
        ...
        _setupOptions() {
          ...
          for (const r in this.rawOptions) {
            const e = { get: h.bind(this, r), set: i.bind(this, r) };
      ...
      var l = this && this.__decorate || function(_, g, h, i) {
        var r, e = arguments.length, t = e < 3 ? g : i === null ? i = Object.getOwnPropertyDescriptor(g, h) : i;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(_, g, h, i);
        else for (var a = _.length - 1; a >= 0; a--) (r = _[a]) && (t = (e < 3 ? r(t) : e > 3 ? r(g, h, t) : r(g, h)) || t);
        return e > 3 && t && Object.defineProperty(g, h, t), t;
      }, u = this && this.__param || function(_, g) {
        return function(h, i) {
          g(h, i, _);
        };
      };
      ...
      let d = s.OscLinkService = class {
        ...
        registerLink(_) {
          ...
          if (_.id === void 0) {
            const a = g.addMarker(g.ybase + g.y), f = { data: _, id: this._nextId++, lines: [a] };
            return a.onDispose(() => this._removeMarkerFromLink(f, a)), this._dataByLinkId.set(f.id, f), f.id;
          }
          const h = _, i = this._getEntryIdKey(h), r = this._entriesWithId.get(i);
        ...
        getLinkData(_) {
          var g;
          return (g = this._dataByLinkId.get(_)) == null ? void 0 : g.data;
        }
        _getEntryIdKey(_) {
          return `${_.id};;${_.uri}`;
        }
        _removeMarkerFromLink(_, g) {
          const h = _.lines.indexOf(g);
          h !== -1 && (_.lines.splice(h, 1), _.lines.length === 0 && (_.data.id !== void 0 && this._entriesWithId.delete(_.key), this._dataByLinkId.delete(_.id)));
        }
      };
      s.OscLinkService = d = l([u(0, n.IBufferService)], d);
    }, 8343: (T, s) => {
      ...
      s.serviceRegistry = /* @__PURE__ */ new Map(), s.getServiceDependencies = function(u) {
        return u[l] || [];
      }, s.createDecorator = function(u) {
        if (s.serviceRegistry.has(u)) return s.serviceRegistry.get(u);
        const n = function(d, _, g) {
          if (arguments.length !== 3) throw new Error("@IServiceName-decorator can only be used to decorate a parameter");
          (function(h, i, r) {
            i[o] === i ? i[l].push({ id: h, index: r }) : (i[l] = [{ id: h, index: r }], i[o] = i);
          })(n, d, g);
        };
        return n.toString = () => u, s.serviceRegistry.set(u, n), n;
      };
    }, 2585: (T, s, o) => {
      ...
      }(u || (s.LogLevelEnum = u = {})), s.ILogService = (0, l.createDecorator)("LogService"), s.IOptionsService = (0, l.createDecorator)("OptionsService"), s.IOscLinkService = (0, l.createDecorator)("OscLinkService"), s.IUnicodeService = (0, l.createDecorator)("UnicodeService"), s.IDecorationService = (0, l.createDecorator)("DecorationService");
    }, 1480: (T, s, o) => {
      Object.defineProperty(s, "__esModule", { value: !0 }), s.UnicodeService = void 0;
      const l = o(8460), u = o(225);
      class n {
        ...
        static createPropertyValue(_, g, h = !1) {
          return (16777215 & _) << 3 | (3 & g) << 1 | (h ? 1 : 0);
        }
        constructor() {
        ...
        getStringCellWidth(_) {
          ...
          const i = _.length;
          for (let r = 0; r < i; ++r) {
            let e = _.charCodeAt(r);
            if (55296 <= e && e <= 56319) {
              if (++r >= i) return g + this.wcwidth(e);
              const f = _.charCodeAt(r);
              56320 <= f && f <= 57343 ? e = 1024 * (e - 55296) + f - 56320 + 65536 : g += this.wcwidth(f);
            }
            const t = this.charProperties(e, h);
            let a = n.extractWidth(t);
            n.extractShouldJoin(t) && (a -= n.extractWidth(h)), g += a, h = t;
          }
          return g;
        }
        charProperties(_, g) {
          return this._activeProvider.charProperties(_, g);
        }
      }
      s.UnicodeService = n;
    } }, J = {};
    function V(T) {
      ...
      var o = J[T] = { exports: {} };
      return Q[T].call(o.exports, o, o.exports, V), o.exports;
    }
    var ee = {};
    return (() => {
      var T = ee;
      Object.defineProperty(T, "__esModule", { value: !0 }), T.Terminal = void 0;
      const s = V(9042), o = V(3236), l = V(844), u = V(5741), n = V(8285), d = V(7975), _ = V(7090), g = ["cols", "rows"];
      class h extends l.Disposable {
        constructor(r) {
          super(), this._core = this.register(new o.Terminal(r)), this._addonManager = this.register(new u.AddonManager()), this._publicOptions = { ...this._core.options };
        ...
        get modes() {
          ...
          return { applicationCursorKeysMode: r.applicationCursorKeys, applicationKeypadMode: r.applicationKeypad, bracketedPasteMode: r.bracketedPasteMode, insertMode: this._core.coreService.modes.insertMode, mouseTrackingMode: e, originMode: r.origin, reverseWraparoundMode: r.reverseWraparound, sendFocusMode: r.sendFocus, wraparoundMode: r.wraparound };
        }
        get options() {
          return this._publicOptions;
        }
        set options(r) {
          for (const e in r) this._publicOptions[e] = r[e];
        }
        blur() {
          this._core.blur();
        }
...
`, e);
        ...
        _verifyIntegers(...r) {
          for (const e of r) if (e === 1 / 0 || isNaN(e) || e % 1 != 0) throw new Error("This API only accepts integers");
        }
        _verifyPositiveIntegers(...r) {
          for (const e of r) if (e && (e === 1 / 0 || isNaN(e) || e % 1 != 0 || e < 0)) throw new Error("This API only accepts positive integers");
        }
      }
      T.Terminal = h;
    })(), ee;
...
var Se = ge.exports;
const De = /* @__PURE__ */ pe(Se), Re = /* @__PURE__ */ ve({
  __proto__: null,
  default: De
}, [Se]);
var Ce = { exports: {} };
    ...
    return (() => {
      ...
      Object.defineProperty(J, "__esModule", { value: !0 }), J.FitAddon = void 0, J.FitAddon = class {
        ...
        fit() {
          ...
          const ee = this._terminal._core;
          this._terminal.rows === V.rows && this._terminal.cols === V.cols || (ee._renderService.clear(), this._terminal.resize(V.cols, V.rows));
        }
        proposeDimensions() {
          if (!this._terminal || !this._terminal.element || !this._terminal.element.parentElement) return;
          const V = this._terminal._core, ee = V._renderService.dimensions;
          if (ee.css.cell.width === 0 || ee.css.cell.height === 0) return;
          const T = this._terminal.options.scrollback === 0 ? 0 : V.viewport.scrollBarWidth, s = window.getComputedStyle(this._terminal.element.parentElement), o = parseInt(s.getPropertyValue("height")), l = Math.max(0, parseInt(s.getPropertyValue("width"))), u = window.getComputedStyle(this._terminal.element), n = o - (parseInt(u.getPropertyValue("padding-top")) + parseInt(u.getPropertyValue("padding-bottom"))), d = l - (parseInt(u.getPropertyValue("padding-right")) + parseInt(u.getPropertyValue("padding-left"))) - T;
          return { cols: Math.max(2, Math.floor(d / ee.css.cell.width)), rows: Math.max(1, Math.floor(n / ee.css.cell.height)) };
        }
      };
    })(), Q;
  })());
...
var be = Ce.exports;
const Ae = /* @__PURE__ */ pe(be), Be = /* @__PURE__ */ ve({
  __proto__: null,
  default: Ae
}, [be]);
var we = { exports: {} };
(function(K, ne) {
  (function(Q, J) {
    ...
    var Q = { 6: (T, s) => {
      function o(u) {
        try {
          const n = new URL(u), d = n.password && n.username ? `${n.protocol}//${n.username}:${n.password}@${n.host}` : n.username ? `${n.protocol}//${n.username}@${n.host}` : `${n.protocol}//${n.host}`;
      ...
      Object.defineProperty(s, "__esModule", { value: !0 }), s.LinkComputer = s.WebLinkProvider = void 0, s.WebLinkProvider = class {
        constructor(u, n, d, _ = {}) {
          this._terminal = u, this._regex = n, this._handler = d, this._options = _;
        }
        provideLinks(u, n) {
          const d = l.computeLink(u, this._regex, this._terminal, this._handler);
          n(this._addCallbacks(d));
        }
        _addCallbacks(u) {
          return u.map((n) => (n.leave = this._options.leave, n.hover = (d, _) => {
            if (this._options.hover) {
              const { range: g } = n;
              this._options.hover(d, _, g);
            }
          }, n));
        }
      };
      class l {
        static computeLink(n, d, _, g) {
          const h = new RegExp(d.source, (d.flags || "") + "g"), [i, r] = l._getWindowedLineStrings(n - 1, _), e = i.join("");
          let t;
          const a = [];
          for (; t = h.exec(e); ) {
            const f = t[0];
            if (!o(f)) continue;
            const [v, p] = l._mapStrIdx(_, r, 0, t.index), [c, m] = l._mapStrIdx(_, v, p, f.length);
            if (v === -1 || p === -1 || c === -1 || m === -1) continue;
            const y = { start: { x: p + 1, y: v + 1 }, end: { x: m, y: c + 1 } };
            a.push({ range: y, text: f, activate: g });
          }
          return a;
        }
        static _getWindowedLineStrings(n, d) {
          let _, g = n, h = n, i = 0, r = "";
          const e = [];
          if (_ = d.buffer.active.getLine(n)) {
            const t = _.translateToString(!0);
            if (_.isWrapped && t[0] !== " ") {
              for (i = 0; (_ = d.buffer.active.getLine(--g)) && i < 2048 && (r = _.translateToString(!0), i += r.length, e.push(r), _.isWrapped && r.indexOf(" ") === -1); ) ;
              e.reverse();
            }
            for (e.push(t), i = 0; (_ = d.buffer.active.getLine(++h)) && _.isWrapped && i < 2048 && (r = _.translateToString(!0), i += r.length, e.push(r), r.indexOf(" ") === -1); ) ;
          }
          return [e, g];
        }
        static _mapStrIdx(n, d, _, g) {
          const h = n.buffer.active, i = h.getNullCell();
          let r = _;
          for (; g; ) {
            const e = h.getLine(d);
            if (!e) return [-1, -1];
            for (let t = r; t < e.length; ++t) {
              e.getCell(t, i);
              const a = i.getChars();
              if (i.getWidth() && (g -= a.length || 1, t === e.length - 1 && a === "")) {
                const f = h.getLine(d + 1);
                f && f.isWrapped && (f.getCell(0, i), i.getWidth() === 2 && (g += 1));
              }
              if (g < 0) return [d, t];
            }
            d++, r = 0;
    ...
    function V(T) {
      ...
      if (s !== void 0) return s.exports;
      var o = J[T] = { exports: {} };
      return Q[T](o, o.exports, V), o.exports;
    }
    var ee = {};
    return (() => {
      var T = ee;
      Object.defineProperty(T, "__esModule", { value: !0 }), T.WebLinksAddon = void 0;
      const s = V(6), o = /(https?|HTTPS?):[/]{2}[^\s"'!*(){}|\\\^<>`]*[^\s"':,.!?{}|\\\^~\[\]`()<>]/;
      function l(u, n) {
        const d = window.open();
        if (d) {
          try {
      ...
      T.WebLinksAddon = class {
        constructor(u = l, n = {}) {
          this._handler = u, this._options = n;
        }
        activate(u) {
          this._terminal = u;
          const n = this._options, d = n.urlRegex || o;
          this._linkProvider = this._terminal.registerLinkProvider(new s.WebLinkProvider(this._terminal, d, this._handler, n));
        }
        dispose() {
          var u;
          (u = this._linkProvider) == null || u.dispose();
        }
      };
    })(), ee;
  })());
...
var ye = we.exports;
const Te = /* @__PURE__ */ pe(ye), Me = /* @__PURE__ */ ve({
  __proto__: null,
  default: Te
}, [ye]);
